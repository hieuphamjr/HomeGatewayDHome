...
public final class EchoNode {
    private static final HashMap<Short, DeviceProxyCreator> mProxyCreators = new HashMap<Short, DeviceProxyCreator>();

    private final NodeProfile mNodeProfile;
    private final List<DeviceObject> mDevices = new ArrayList<DeviceObject>();
    ...
    private static DeviceObject newOtherDevice(short echoClassCode, byte instanceCode) {
        ...
        switch (echoClassCode) {
            ...
            case InstantaneousWaterHeater.ECHO_CLASS_CODE:
                return new InstantaneousWaterHeater.Proxy(instanceCode);
            case LPGasMeter.ECHO_CLASS_CODE:
