...
public abstract class EmergencyButton extends DeviceObject {
     ...
     * Get - undefined<br>
     */
    protected boolean setEmergencyOccurrenceStatusResetting(byte[] edt) {
        return false;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_EMERGENCY_OCCURRENCE_STATUS_RESETTING:
                return setEmergencyOccurrenceStatusResetting(property.edt);
            default:
                return false;
        }
    }
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            case EPC_EMERGENCY_OCCURRENCE_STATUS:
                return getEmergencyOccurrenceStatus();
            default:
                return null;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_EMERGENCY_OCCURRENCE_STATUS:
                return isValidEmergencyOccurrenceStatus(property.edt);
            case EPC_EMERGENCY_OCCURRENCE_STATUS_RESETTING:
                return isValidEmergencyOccurrenceStatusResetting(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends EmergencyButton {
        ...
        @Override
        protected byte[] getEmergencyOccurrenceStatus() {
            return null;
        }
    }
