...
public abstract class BathWaterLevelSensor extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected byte[] getBathWaterLevelOverDetectionThresholdLevel() {
        return null;
    }
     ...
     * <b>Announcement at status change</b><br>
     */
    protected byte[] getBathWaterLevelOverDetectionStatus() {
        return null;
    }
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            case EPC_BATH_WATER_LEVEL_OVER_DETECTION_THRESHOLD_LEVEL:
                return getBathWaterLevelOverDetectionThresholdLevel();
            case EPC_BATH_WATER_LEVEL_OVER_DETECTION_STATUS:
                return getBathWaterLevelOverDetectionStatus();
            case EPC_MEASURED_VALUE_OF_BATH_WATER_LEVEL:
                return getMeasuredValueOfBathWaterLevel();
            default:
                return null;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_BATH_WATER_LEVEL_OVER_DETECTION_THRESHOLD_LEVEL:
                return isValidBathWaterLevelOverDetectionThresholdLevel(property.edt);
            case EPC_BATH_WATER_LEVEL_OVER_DETECTION_STATUS:
                return isValidBathWaterLevelOverDetectionStatus(property.edt);
            case EPC_MEASURED_VALUE_OF_BATH_WATER_LEVEL:
                return isValidMeasuredValueOfBathWaterLevel(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends BathWaterLevelSensor {
        ...
        @Override
        protected byte[] getMeasuredValueOfBathWaterLevel() {
            return null;
        }
    }
