...
public abstract class MicromotionSensor extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected boolean setDetectionThresholdLevel(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getDetectionThresholdLevel() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setDetectionCounter(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getDetectionCounter() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setSamplingCount(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getSamplingCount() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setSamplingCycle(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getSamplingCycle() {
        return null;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_DETECTION_THRESHOLD_LEVEL:
                return setDetectionThresholdLevel(property.edt);
            case EPC_DETECTION_COUNTER:
                return setDetectionCounter(property.edt);
            case EPC_SAMPLING_COUNT:
                return setSamplingCount(property.edt);
            case EPC_SAMPLING_CYCLE:
                return setSamplingCycle(property.edt);
            default:
                return false;
        }
    }
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            case EPC_DETECTION_THRESHOLD_LEVEL:
                return getDetectionThresholdLevel();
            case EPC_MICROMOTION_DETECTION_STATUS:
                return getMicromotionDetectionStatus();
            case EPC_DETECTION_COUNTER:
                return getDetectionCounter();
            case EPC_SAMPLING_COUNT:
                return getSamplingCount();
            case EPC_SAMPLING_CYCLE:
                return getSamplingCycle();
            default:
                return null;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_DETECTION_THRESHOLD_LEVEL:
                return isValidDetectionThresholdLevel(property.edt);
            case EPC_MICROMOTION_DETECTION_STATUS:
                return isValidMicromotionDetectionStatus(property.edt);
            case EPC_DETECTION_COUNTER:
                return isValidDetectionCounter(property.edt);
            case EPC_SAMPLING_COUNT:
                return isValidSamplingCount(property.edt);
            case EPC_SAMPLING_CYCLE:
                return isValidSamplingCycle(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends MicromotionSensor {
        ...
        @Override
        protected byte[] getMicromotionDetectionStatus() {
            return null;
        }
    }
