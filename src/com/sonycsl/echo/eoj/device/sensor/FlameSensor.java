...
public abstract class FlameSensor extends DeviceObject {
     ...
     * Get - undefined<br>
     */
    protected boolean setFlameDetectionStatusResetting(byte[] edt) {
        return false;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            ...
            case EPC_FLAME_DETECTION_STATUS_RESETTING:
                return setFlameDetectionStatusResetting(property.edt);
            default:
                return false;
        }
    }
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            ...
            case EPC_FLAME_DETECTION_STATUS:
                return getFlameDetectionStatus();
            default:
                return null;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            ...
            case EPC_FLAME_DETECTION_STATUS:
                return isValidFlameDetectionStatus(property.edt);
            case EPC_FLAME_DETECTION_STATUS_RESETTING:
                return isValidFlameDetectionStatusResetting(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends FlameSensor {
        ...
        @Override
        protected byte[] getFlameDetectionStatus() {
            return null;
        }
    }
