...
public abstract class ElectricEnergySensor extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected byte[] getMediumCapacitySensorInstantaneousElectricEnergy() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getSmallCapacitySensorInstantaneousElectricEnergy() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getLargeCapacitySensorInstantaneousElectricEnergy() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getIntegralElectricEnergyMeasurementLog() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getEffectiveVoltageValue() {
        return null;
    }
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            case EPC_INTEGRAL_ELECTRIC_ENERGY:
                return getIntegralElectricEnergy();
            case EPC_MEDIUM_CAPACITY_SENSOR_INSTANTANEOUS_ELECTRIC_ENERGY:
                return getMediumCapacitySensorInstantaneousElectricEnergy();
            case EPC_SMALL_CAPACITY_SENSOR_INSTANTANEOUS_ELECTRIC_ENERGY:
                return getSmallCapacitySensorInstantaneousElectricEnergy();
            case EPC_LARGE_CAPACITY_SENSOR_INSTANTANEOUS_ELECTRIC_ENERGY:
                return getLargeCapacitySensorInstantaneousElectricEnergy();
            case EPC_INTEGRAL_ELECTRIC_ENERGY_MEASUREMENT_LOG:
                return getIntegralElectricEnergyMeasurementLog();
            case EPC_EFFECTIVE_VOLTAGE_VALUE:
                return getEffectiveVoltageValue();
            default:
                return null;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_INTEGRAL_ELECTRIC_ENERGY:
                return isValidIntegralElectricEnergy(property.edt);
            case EPC_MEDIUM_CAPACITY_SENSOR_INSTANTANEOUS_ELECTRIC_ENERGY:
                return isValidMediumCapacitySensorInstantaneousElectricEnergy(property.edt);
            case EPC_SMALL_CAPACITY_SENSOR_INSTANTANEOUS_ELECTRIC_ENERGY:
                return isValidSmallCapacitySensorInstantaneousElectricEnergy(property.edt);
            case EPC_LARGE_CAPACITY_SENSOR_INSTANTANEOUS_ELECTRIC_ENERGY:
                return isValidLargeCapacitySensorInstantaneousElectricEnergy(property.edt);
            case EPC_INTEGRAL_ELECTRIC_ENERGY_MEASUREMENT_LOG:
                return isValidIntegralElectricEnergyMeasurementLog(property.edt);
            case EPC_EFFECTIVE_VOLTAGE_VALUE:
                return isValidEffectiveVoltageValue(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends ElectricEnergySensor {
        ...
        @Override
        protected byte[] getIntegralElectricEnergy() {
            return null;
        }
    }
