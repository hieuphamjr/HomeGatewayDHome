...
public abstract class IlluminanceSensor extends DeviceObject {
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            case EPC_MEASURED_ILLUMINANCE_VALUE1:
                return getMeasuredIlluminanceValue1();
            case EPC_MEASURED_ILLUMINANCE_VALUE2:
                return getMeasuredIlluminanceValue2();
            default:
                return null;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_MEASURED_ILLUMINANCE_VALUE1:
                return isValidMeasuredIlluminanceValue1(property.edt);
            case EPC_MEASURED_ILLUMINANCE_VALUE2:
                return isValidMeasuredIlluminanceValue2(property.edt);
            default:
                return false;
        }
    }
