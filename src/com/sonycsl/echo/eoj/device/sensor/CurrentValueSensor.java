...
public abstract class CurrentValueSensor extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected byte[] getRatedVoltageToBeMeasured() {
        return null;
    }
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            case EPC_MEASURED_CURRENT_VALUE1:
                return getMeasuredCurrentValue1();
            case EPC_RATED_VOLTAGE_TO_BE_MEASURED:
                return getRatedVoltageToBeMeasured();
            case EPC_MEASURED_CURRENT_VALUE2:
                return getMeasuredCurrentValue2();
            default:
                return null;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_MEASURED_CURRENT_VALUE1:
                return isValidMeasuredCurrentValue1(property.edt);
            case EPC_RATED_VOLTAGE_TO_BE_MEASURED:
                return isValidRatedVoltageToBeMeasured(property.edt);
            case EPC_MEASURED_CURRENT_VALUE2:
                return isValidMeasuredCurrentValue2(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends CurrentValueSensor {
        ...
        @Override
        protected byte[] getMeasuredCurrentValue1() {
            return null;
        }

        @Override
        protected byte[] getMeasuredCurrentValue2() {
            return null;
        }
    }
