...
public abstract class HumanBodyLocationSensor extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected byte[] getMaximumNumberOfHumanBodyIdS() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getHumanBodyExistenceInformation() {
        return null;
    }
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            case EPC_HUMAN_BODY_DETECTION_LOCATION1:
                return getHumanBodyDetectionLocation1();
            case EPC_MAXIMUM_NUMBER_OF_HUMAN_BODY_ID_S:
                return getMaximumNumberOfHumanBodyIdS();
            case EPC_HUMAN_BODY_DETECTION_LOCATION2:
                return getHumanBodyDetectionLocation2();
            case EPC_HUMAN_BODY_EXISTENCE_INFORMATION:
                return getHumanBodyExistenceInformation();
            default:
                return null;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_HUMAN_BODY_DETECTION_LOCATION1:
                return isValidHumanBodyDetectionLocation1(property.edt);
            case EPC_MAXIMUM_NUMBER_OF_HUMAN_BODY_ID_S:
                return isValidMaximumNumberOfHumanBodyIdS(property.edt);
            case EPC_HUMAN_BODY_DETECTION_LOCATION2:
                return isValidHumanBodyDetectionLocation2(property.edt);
            case EPC_HUMAN_BODY_EXISTENCE_INFORMATION:
                return isValidHumanBodyExistenceInformation(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends HumanBodyLocationSensor {
        ...
        @Override
        protected byte[] getHumanBodyDetectionLocation1() {
            return null;
        }

        @Override
        protected byte[] getHumanBodyDetectionLocation2() {
            return null;
        }
    }
