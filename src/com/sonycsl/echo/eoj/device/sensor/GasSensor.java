...
public abstract class GasSensor extends DeviceObject {
     ...
     * <b>Announcement at status change</b><br>
     */
    protected byte[] getGasDetectionStatus() {
        return null;
    }
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            ...
            case EPC_GAS_DETECTION_STATUS:
                return getGasDetectionStatus();
            case EPC_MEASURED_VALUE_OF_GAS_CONCENTRATION:
                return getMeasuredValueOfGasConcentration();
            default:
                return null;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            ...
            case EPC_GAS_DETECTION_STATUS:
                return isValidGasDetectionStatus(property.edt);
            case EPC_MEASURED_VALUE_OF_GAS_CONCENTRATION:
                return isValidMeasuredValueOfGasConcentration(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends GasSensor {
        ...
        @Override
        protected byte[] getMeasuredValueOfGasConcentration() {
            return null;
        }
    }
