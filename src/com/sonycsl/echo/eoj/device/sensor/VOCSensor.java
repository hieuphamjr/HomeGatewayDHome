...
public abstract class VOCSensor extends DeviceObject {
     ...
     * <b>Announcement at status change</b><br>
     */
    protected byte[] getVocDetectionStatus() {
        return null;
    }
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            ...
            case EPC_VOC_DETECTION_STATUS:
                return getVocDetectionStatus();
            case EPC_MEASURED_VALUE_OF_VOC_CONCENTRATION:
                return getMeasuredValueOfVocConcentration();
            default:
                return null;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            ...
            case EPC_VOC_DETECTION_STATUS:
                return isValidVocDetectionStatus(property.edt);
            case EPC_MEASURED_VALUE_OF_VOC_CONCENTRATION:
                return isValidMeasuredValueOfVocConcentration(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends VOCSensor {
        ...
        @Override
        protected byte[] getMeasuredValueOfVocConcentration() {
            return null;
        }
    }
