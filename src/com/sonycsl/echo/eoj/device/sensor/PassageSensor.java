...
public abstract class PassageSensor extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected boolean setPassageDetectionHoldTime(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getPassageDetectionHoldTime() {
        return null;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            ...
            case EPC_PASSAGE_DETECTION_HOLD_TIME:
                return setPassageDetectionHoldTime(property.edt);
            default:
                return false;
        }
    }
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            ...
            case EPC_PASSAGE_DETECTION_HOLD_TIME:
                return getPassageDetectionHoldTime();
            case EPC_PASSAGE_DETECTION_DIRECTION:
                return getPassageDetectionDirection();
            default:
                return null;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            ...
            case EPC_PASSAGE_DETECTION_HOLD_TIME:
                return isValidPassageDetectionHoldTime(property.edt);
            case EPC_PASSAGE_DETECTION_DIRECTION:
                return isValidPassageDetectionDirection(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends PassageSensor {
        ...
        @Override
        protected byte[] getPassageDetectionDirection() {
            return null;
        }
    }
