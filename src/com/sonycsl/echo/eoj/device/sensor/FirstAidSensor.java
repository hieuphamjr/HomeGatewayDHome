...
public abstract class FirstAidSensor extends DeviceObject {
     ...
     * Get - undefined<br>
     */
    protected boolean setFirstAidOccurrenceStatusResetting(byte[] edt) {
        return false;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            ...
            case EPC_FIRST_AID_OCCURRENCE_STATUS_RESETTING:
                return setFirstAidOccurrenceStatusResetting(property.edt);
            default:
                return false;
        }
    }
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            ...
            case EPC_FIRST_AID_OCCURRENCE_STATUS:
                return getFirstAidOccurrenceStatus();
            default:
                return null;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            ...
            case EPC_FIRST_AID_OCCURRENCE_STATUS:
                return isValidFirstAidOccurrenceStatus(property.edt);
            case EPC_FIRST_AID_OCCURRENCE_STATUS_RESETTING:
                return isValidFirstAidOccurrenceStatusResetting(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends FirstAidSensor {
        ...
        @Override
        protected byte[] getFirstAidOccurrenceStatus() {
            return null;
        }
    }
