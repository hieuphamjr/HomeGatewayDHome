...
public abstract class CallSensor extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected boolean setCallHoldingTime(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getCallHoldingTime() {
        return null;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            ...
            case EPC_CALL_HOLDING_TIME:
                return setCallHoldingTime(property.edt);
            default:
                return false;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            ...
            case EPC_CALL_STATUS:
                return isValidCallStatus(property.edt);
            case EPC_CALL_HOLDING_TIME:
                return isValidCallHoldingTime(property.edt);
            default:
                return false;
        }
    }
