...
public abstract class OpenCloseSensor extends DeviceObject {
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            case EPC_DEGREE_OF_OPENI_NG_DETECTION_STATUS1:
                return getDegreeOfOpeniNgDetectionStatus1();
            case EPC_DETECTION_THRESHOLD_LEVEL:
                return getDetectionThresholdLevel();
            case EPC_DEGREE_OF_OPENI_NG_DETECTION_STATUS2:
                return getDegreeOfOpeniNgDetectionStatus2();
            default:
                return null;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_DEGREE_OF_OPENI_NG_DETECTION_STATUS1:
                return isValidDegreeOfOpeniNgDetectionStatus1(property.edt);
            case EPC_DETECTION_THRESHOLD_LEVEL:
                return isValidDetectionThresholdLevel(property.edt);
            case EPC_DEGREE_OF_OPENI_NG_DETECTION_STATUS2:
                return isValidDegreeOfOpeniNgDetectionStatus2(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends OpenCloseSensor {
        ...
        @Override
        protected byte[] getDegreeOfOpeniNgDetectionStatus1() {
            return null;
        }

        @Override
        protected byte[] getDegreeOfOpeniNgDetectionStatus2() {
            return null;
        }
    }
