...
public abstract class ActivityAmountSensor extends DeviceObject {
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_ACTIVITY_AMOUNT_LEVEL1:
                return isValidActivityAmountLevel1(property.edt);
            case EPC_MAXIMUM_NUMBER_OF_HUMAN_BODY_ID_S:
                return isValidMaximumNumberOfHumanBodyIdS(property.edt);
            case EPC_ACTIVITY_AMOUNT_LEVEL2:
                return isValidActivityAmountLevel2(property.edt);
            case EPC_HUMAN_BODY_EXISTENCE_INFORMATION:
    ...
    public static class Proxy extends ActivityAmountSensor {
        ...
        @Override
        protected byte[] getActivityAmountLevel1() {
            return null;
        }

        @Override
        protected byte[] getActivityAmountLevel2() {
            return null;
        }
    }
