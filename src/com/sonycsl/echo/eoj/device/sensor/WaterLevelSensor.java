...
public abstract class WaterLevelSensor extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected byte[] getWaterLevelOverDetectionThresholdLevel() {
        return null;
    }
     ...
     * <b>Announcement at status change</b><br>
     */
    protected byte[] getWaterLevelOverDetectionStatus() {
        return null;
    }
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            case EPC_WATER_LEVEL_OVER_DETECTION_THRESHOLD_LEVEL:
                return getWaterLevelOverDetectionThresholdLevel();
            case EPC_WATER_LEVEL_OVER_DETECTION_STATUS:
                return getWaterLevelOverDetectionStatus();
            case EPC_MEASURED_VALUE_OF_WATER_LEVEL:
                return getMeasuredValueOfWaterLevel();
            default:
                return null;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_WATER_LEVEL_OVER_DETECTION_THRESHOLD_LEVEL:
                return isValidWaterLevelOverDetectionThresholdLevel(property.edt);
            case EPC_WATER_LEVEL_OVER_DETECTION_STATUS:
                return isValidWaterLevelOverDetectionStatus(property.edt);
            case EPC_MEASURED_VALUE_OF_WATER_LEVEL:
                return isValidMeasuredValueOfWaterLevel(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends WaterLevelSensor {
        ...
        @Override
        protected byte[] getMeasuredValueOfWaterLevel() {
            return null;
        }
    }
