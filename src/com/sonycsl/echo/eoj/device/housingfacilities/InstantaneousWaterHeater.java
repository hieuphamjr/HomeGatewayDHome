...
public abstract class InstantaneousWaterHeater extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected boolean setSetValueOfHotWaterTemperature(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setHotWaterWarmerSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setDurationOfAutomaticOperationSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setSetValueOfBathTemperature(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setBathAdditionalBoilUpOperationSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setBathHotWaterAddingOperationSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setBathWaterTemperatureLoweringOperationSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setBathHotWaterVolumeSetting1(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setBathHotWaterVolumeSetting2(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setBathHotWaterVolumeSetting3(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setBathroomPrioritySetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setHotWaterWarmerOnTimerReservationSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setSetValueOfHotWaterWarmerOnTimerTime(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setSetValueOfOnTimerTime(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setSetValueOfOnTimerRelativeTime(byte[] edt) {
        return false;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_SET_VALUE_OF_HOT_WATER_TEMPERATURE:
                return setSetValueOfHotWaterTemperature(property.edt);
            case EPC_HOT_WATER_WARMER_SETTING:
                return setHotWaterWarmerSetting(property.edt);
            case EPC_DURATION_OF_AUTOMATIC_OPERATION_SETTING:
                return setDurationOfAutomaticOperationSetting(property.edt);
            case EPC_SET_VALUE_OF_BATH_TEMPERATURE:
                return setSetValueOfBathTemperature(property.edt);
            case EPC_BATH_AUTO_MODE_SETTING:
                return setBathAutoModeSetting(property.edt);
            case EPC_BATH_ADDITIONAL_BOIL_UP_OPERATION_SETTING:
                return setBathAdditionalBoilUpOperationSetting(property.edt);
            case EPC_BATH_HOT_WATER_ADDING_OPERATION_SETTING:
                return setBathHotWaterAddingOperationSetting(property.edt);
            case EPC_BATH_WATER_TEMPERATURE_LOWERING_OPERATION_SETTING:
                return setBathWaterTemperatureLoweringOperationSetting(property.edt);
            case EPC_BATH_HOT_WATER_VOLUME_SETTING1:
                return setBathHotWaterVolumeSetting1(property.edt);
            case EPC_BATH_HOT_WATER_VOLUME_SETTING2:
                return setBathHotWaterVolumeSetting2(property.edt);
            case EPC_BATH_HOT_WATER_VOLUME_SETTING3:
                return setBathHotWaterVolumeSetting3(property.edt);
            case EPC_BATHROOM_PRIORITY_SETTING:
                return setBathroomPrioritySetting(property.edt);
            case EPC_HOT_WATER_WARMER_ON_TIMER_RESERVATION_SETTING:
                return setHotWaterWarmerOnTimerReservationSetting(property.edt);
            case EPC_SET_VALUE_OF_HOT_WATER_WARMER_ON_TIMER_TIME:
                return setSetValueOfHotWaterWarmerOnTimerTime(property.edt);
            case EPC_ON_TIMER_RESERVATION_SETTING:
                return setOnTimerReservationSetting(property.edt);
            case EPC_SET_VALUE_OF_ON_TIMER_TIME:
                return setSetValueOfOnTimerTime(property.edt);
            case EPC_SET_VALUE_OF_ON_TIMER_RELATIVE_TIME:
                return setSetValueOfOnTimerRelativeTime(property.edt);
            default:
                return false;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_HOT_WATER_HEATING_STATUS:
                return isValidHotWaterHeatingStatus(property.edt);
            case EPC_SET_VALUE_OF_HOT_WATER_TEMPERATURE:
                return isValidSetValueOfHotWaterTemperature(property.edt);
            case EPC_HOT_WATER_WARMER_SETTING:
                return isValidHotWaterWarmerSetting(property.edt);
            case EPC_DURATION_OF_AUTOMATIC_OPERATION_SETTING:
                return isValidDurationOfAutomaticOperationSetting(property.edt);
            case EPC_REMAINING_AUTOMATIC_OPERATION_TIME:
                return isValidRemainingAutomaticOperationTime(property.edt);
            case EPC_SET_VALUE_OF_BATH_TEMPERATURE:
                return isValidSetValueOfBathTemperature(property.edt);
            case EPC_BATH_WATER_HEATER_STATUS:
                return isValidBathWaterHeaterStatus(property.edt);
            case EPC_BATH_AUTO_MODE_SETTING:
                return isValidBathAutoModeSetting(property.edt);
            case EPC_BATH_ADDITIONAL_BOIL_UP_OPERATION_SETTING:
                return isValidBathAdditionalBoilUpOperationSetting(property.edt);
            case EPC_BATH_HOT_WATER_ADDING_OPERATION_SETTING:
                return isValidBathHotWaterAddingOperationSetting(property.edt);
            case EPC_BATH_WATER_TEMPERATURE_LOWERING_OPERATION_SETTING:
                return isValidBathWaterTemperatureLoweringOperationSetting(property.edt);
            case EPC_BATH_HOT_WATER_VOLUME_SETTING1:
                return isValidBathHotWaterVolumeSetting1(property.edt);
            case EPC_BATH_HOT_WATER_VOLUME_SETTING2:
                return isValidBathHotWaterVolumeSetting2(property.edt);
            case EPC_BATH_HOT_WATER_VOLUME_SETTING3:
                return isValidBathHotWaterVolumeSetting3(property.edt);
            case EPC_BATHROOM_PRIORITY_SETTING:
                return isValidBathroomPrioritySetting(property.edt);
            case EPC_SHOWER_HOT_WATER_SUPPLY_STATUS:
                return isValidShowerHotWaterSupplyStatus(property.edt);
            case EPC_KITCHEN_HOT_WATER_SUPPLY_STATUS:
                return isValidKitchenHotWaterSupplyStatus(property.edt);
            case EPC_HOT_WATER_WARMER_ON_TIMER_RESERVATION_SETTING:
                return isValidHotWaterWarmerOnTimerReservationSetting(property.edt);
            case EPC_SET_VALUE_OF_HOT_WATER_WARMER_ON_TIMER_TIME:
                return isValidSetValueOfHotWaterWarmerOnTimerTime(property.edt);
            case EPC_ON_TIMER_RESERVATION_SETTING:
                return isValidOnTimerReservationSetting(property.edt);
            case EPC_SET_VALUE_OF_ON_TIMER_TIME:
                return isValidSetValueOfOnTimerTime(property.edt);
            case EPC_SET_VALUE_OF_ON_TIMER_RELATIVE_TIME:
                return isValidSetValueOfOnTimerRelativeTime(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends InstantaneousWaterHeater {
        ...
        @Override
        protected boolean setBathAutoModeSetting(byte[] edt) {
            return false;
        }
