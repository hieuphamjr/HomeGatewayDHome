...
public abstract class ElectricShutter extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected boolean setExtentOfOpening1(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getExtentOfOpening1() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setBlindAngleSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getBlindAngleSetting() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setShutterSpeed(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getShutterSpeed() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setExtentOfOpening2(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getExtentOfOpening2() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setElectricLockSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getElectricLockSetting() {
        return null;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_OPEN_CLOSE_SETTING1:
                return setOpenCloseSetting1(property.edt);
            case EPC_EXTENT_OF_OPENING1:
                return setExtentOfOpening1(property.edt);
            case EPC_BLIND_ANGLE_SETTING:
                return setBlindAngleSetting(property.edt);
            case EPC_SHUTTER_SPEED:
                return setShutterSpeed(property.edt);
            case EPC_EXTENT_OF_OPENING2:
                return setExtentOfOpening2(property.edt);
            case EPC_ELECTRIC_LOCK_SETTING:
                return setElectricLockSetting(property.edt);
            case EPC_OPEN_CLOSE_SETTING2:
                return setOpenCloseSetting2(property.edt);
            default:
                return false;
        }
    }
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            case EPC_OPEN_CLOSE_SETTING1:
                return getOpenCloseSetting1();
            case EPC_EXTENT_OF_OPENING1:
                return getExtentOfOpening1();
            case EPC_BLIND_ANGLE_SETTING:
                return getBlindAngleSetting();
            case EPC_SHUTTER_SPEED:
                return getShutterSpeed();
            case EPC_EXTENT_OF_OPENING2:
                return getExtentOfOpening2();
            case EPC_ELECTRIC_LOCK_SETTING:
                return getElectricLockSetting();
            case EPC_OPEN_CLOSE_SETTING2:
                return getOpenCloseSetting2();
            default:
                return null;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_OPEN_CLOSE_SETTING1:
                return isValidOpenCloseSetting1(property.edt);
            case EPC_EXTENT_OF_OPENING1:
                return isValidExtentOfOpening1(property.edt);
            case EPC_BLIND_ANGLE_SETTING:
                return isValidBlindAngleSetting(property.edt);
            case EPC_SHUTTER_SPEED:
                return isValidShutterSpeed(property.edt);
            case EPC_EXTENT_OF_OPENING2:
                return isValidExtentOfOpening2(property.edt);
            case EPC_ELECTRIC_LOCK_SETTING:
                return isValidElectricLockSetting(property.edt);
            case EPC_OPEN_CLOSE_SETTING2:
                return isValidOpenCloseSetting2(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends ElectricShutter {
        ...
        @Override
        protected boolean setOpenCloseSetting1(byte[] edt) {
            return false;
        }

        @Override
        protected byte[] getOpenCloseSetting1() {
            return null;
        }

        @Override
        protected boolean setOpenCloseSetting2(byte[] edt) {
            return false;
        }

        @Override
        protected byte[] getOpenCloseSetting2() {
            return null;
        }
    }
