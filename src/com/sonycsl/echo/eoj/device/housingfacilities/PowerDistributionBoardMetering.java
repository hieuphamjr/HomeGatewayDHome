...
public abstract class PowerDistributionBoardMetering extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected boolean setDayForWhichTheHistoricalDataOfMeasuredCumulativeAmountsOfElectricEnergyIsToBeRetrieved(byte[] edt) {
        return false;
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            ...
            case EPC_MEASURED_CUMULATIVE_AMOUNT_OF_ELECTRIC_ENERGY_REVERSE_DIRECTION:
                return isValidMeasuredCumulativeAmountOfElectricEnergyReverseDirection(property.edt);
            case EPC_UNIT_FOR_CUMULATIVE_AMOUNTS_OF_ELECTRIC_ENERGY:
                return isValidUnitForCumulativeAmountsOfElectricEnergy(property.edt);
            case EPC_HISTORICAL_DATA_OF_MEASURED_CUMULATIVE_AMOUNTS_OF_ELECTRIC_ENERGY_NORMAL_DIRECTION:
            ...
            case EPC_MEASURED_INSTANTANEO_US_AMOUNT_OF_ELECTRIC_ENERGY:
                return isValidMeasuredInstantaneoUsAmountOfElectricEnergy(property.edt);
            case EPC_MEASURED_INSTANTANEOUS_CURRENTS:
                return isValidMeasuredInstantaneousCurrents(property.edt);
            case EPC_MEASURED_INSTANTANEOUS_VOLTAGES:
                return isValidMeasuredInstantaneousVoltages(property.edt);
            case EPC_MEASUREMENT_CHANNEL1:
                return isValidMeasurementChannel1(property.edt);
            case EPC_MEASUREMENT_CHANNEL2:
                return isValidMeasurementChannel2(property.edt);
            case EPC_MEASUREMENT_CHANNEL3:
                return isValidMeasurementChannel3(property.edt);
            case EPC_MEASUREMENT_CHANNEL4:
                return isValidMeasurementChannel4(property.edt);
            case EPC_MEASUREMENT_CHANNEL5:
                return isValidMeasurementChannel5(property.edt);
            case EPC_MEASUREMENT_CHANNEL6:
                return isValidMeasurementChannel6(property.edt);
            case EPC_MEASUREMENT_CHANNEL7:
                return isValidMeasurementChannel7(property.edt);
            case EPC_MEASUREMENT_CHANNEL8:
                return isValidMeasurementChannel8(property.edt);
            case EPC_MEASUREMENT_CHANNEL9:
                return isValidMeasurementChannel9(property.edt);
            case EPC_MEASUREMENT_CHANNEL10:
                return isValidMeasurementChannel10(property.edt);
            case EPC_MEASUREMENT_CHANNEL11:
                return isValidMeasurementChannel11(property.edt);
            case EPC_MEASUREMENT_CHANNEL12:
                return isValidMeasurementChannel12(property.edt);
            case EPC_MEASUREMENT_CHANNEL13:
                return isValidMeasurementChannel13(property.edt);
            case EPC_MEASUREMENT_CHANNEL14:
                return isValidMeasurementChannel14(property.edt);
            case EPC_MEASUREMENT_CHANNEL15:
                return isValidMeasurementChannel15(property.edt);
            case EPC_MEASUREMENT_CHANNEL16:
                return isValidMeasurementChannel16(property.edt);
            case EPC_MEASUREMENT_CHANNEL17:
                return isValidMeasurementChannel17(property.edt);
            case EPC_MEASUREMENT_CHANNEL18:
                return isValidMeasurementChannel18(property.edt);
            case EPC_MEASUREMENT_CHANNEL19:
                return isValidMeasurementChannel19(property.edt);
            case EPC_MEASUREMENT_CHANNEL20:
                return isValidMeasurementChannel20(property.edt);
            case EPC_MEASUREMENT_CHANNEL21:
                return isValidMeasurementChannel21(property.edt);
            case EPC_MEASUREMENT_CHANNEL22:
                return isValidMeasurementChannel22(property.edt);
            case EPC_MEASUREMENT_CHANNEL23:
                return isValidMeasurementChannel23(property.edt);
            case EPC_MEASUREMENT_CHANNEL24:
                return isValidMeasurementChannel24(property.edt);
            case EPC_MEASUREMENT_CHANNEL25:
                return isValidMeasurementChannel25(property.edt);
            case EPC_MEASUREMENT_CHANNEL26:
                return isValidMeasurementChannel26(property.edt);
            case EPC_MEASUREMENT_CHANNEL27:
                return isValidMeasurementChannel27(property.edt);
            case EPC_MEASUREMENT_CHANNEL28:
                return isValidMeasurementChannel28(property.edt);
            case EPC_MEASUREMENT_CHANNEL29:
                return isValidMeasurementChannel29(property.edt);
            case EPC_MEASUREMENT_CHANNEL30:
                return isValidMeasurementChannel30(property.edt);
            case EPC_MEASUREMENT_CHANNEL31:
                return isValidMeasurementChannel31(property.edt);
            case EPC_MEASUREMENT_CHANNEL32:
                return isValidMeasurementChannel32(property.edt);
            default:
                return false;
        }
    }
