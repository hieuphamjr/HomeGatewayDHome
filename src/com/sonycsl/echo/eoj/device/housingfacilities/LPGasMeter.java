...
public abstract class LPGasMeter extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected boolean setSetValueOfResidualVolumeControlWarningLevel1(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setSetValueOfResidualVolumeControlWarningLevel2(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setSetValueOfResidualVolumeControlWarningLevel3(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setTestCallSetting(byte[] edt) {
        return false;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_SET_VALUE_OF_RESIDUAL_VOLUME_CONTROL_WARNING_LEVEL1:
                return setSetValueOfResidualVolumeControlWarningLevel1(property.edt);
            case EPC_SET_VALUE_OF_RESIDUAL_VOLUME_CONTROL_WARNING_LEVEL2:
                return setSetValueOfResidualVolumeControlWarningLevel2(property.edt);
            case EPC_SET_VALUE_OF_RESIDUAL_VOLUME_CONTROL_WARNING_LEVEL3:
                return setSetValueOfResidualVolumeControlWarningLevel3(property.edt);
            case EPC_TEST_CALL_SETTING:
                return setTestCallSetting(property.edt);
            default:
                return false;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_INTEGRAL_GAS_CONSUMPTION_OF_METERING_DATA1:
                return isValidIntegralGasConsumptionOfMeteringData1(property.edt);
            case EPC_INTEGRAL_GAS_CONSUMPTION_OF_METERING_DATA2:
                return isValidIntegralGasConsumptionOfMeteringData2(property.edt);
            case EPC_ERROR_DETECTION_STATUSOF_METERING_DATA:
                return isValidErrorDetectionStatusofMeteringData(property.edt);
            case EPC_SECURITY_DATA1:
                return isValidSecurityData1(property.edt);
            case EPC_SECURITY_DATA2:
                return isValidSecurityData2(property.edt);
            case EPC_CENTER_VALVE_SHUT_OFF_STATUS:
                return isValidCenterValveShutOffStatus(property.edt);
            case EPC_CENTER_VALVE_SHUT_OFF_RECOVERY_PERMISSION_SETTING_STATUS:
                return isValidCenterValveShutOffRecoveryPermissionSettingStatus(property.edt);
            case EPC_EMERGENCY_VALVE_SHUT_OFF_STATUS:
                return isValidEmergencyValveShutOffStatus(property.edt);
            case EPC_SHUT_OFF_VALVE_OPEN_CLOSE_STATUS:
                return isValidShutOffValveOpenCloseStatus(property.edt);
            case EPC_RESIDUAL_VOLUME_CONTROL_WARNING:
                return isValidResidualVolumeControlWarning(property.edt);
            case EPC_SET_VALUE_OF_RESIDUAL_VOLUME_CONTROL_WARNING_LEVEL1:
                return isValidSetValueOfResidualVolumeControlWarningLevel1(property.edt);
            case EPC_SET_VALUE_OF_RESIDUAL_VOLUME_CONTROL_WARNING_LEVEL2:
                return isValidSetValueOfResidualVolumeControlWarningLevel2(property.edt);
            case EPC_SET_VALUE_OF_RESIDUAL_VOLUME_CONTROL_WARNING_LEVEL3:
                return isValidSetValueOfResidualVolumeControlWarningLevel3(property.edt);
            case EPC_SLIGHT_LEAK_TIMER_VALUE_GAS_FLOW_RATE_CONTINUATION:
                return isValidSlightLeakTimerValueGasFlowRateContinuation(property.edt);
            case EPC_SLIGHT_LEAK_TIMER_VALUE_WITHOUT_PRESSURE_INCREASE:
                return isValidSlightLeakTimerValueWithoutPressureIncrease(property.edt);
            case EPC_SHUT_OFF_REASON_LOG:
                return isValidShutOffReasonLog(property.edt);
            case EPC_MAXIMUM_VALUE_OF_SUPPLY_PRESSURE_DATA:
                return isValidMaximumValueOfSupplyPressureData(property.edt);
            case EPC_MINIMUM_VALUE_OF_SUPPLY_PRESSURE_DATA:
                return isValidMinimumValueOfSupplyPressureData(property.edt);
            case EPC_CURRENT_VALUE_OF_SUPPLY_PRESSURE_DATA:
                return isValidCurrentValueOfSupplyPressureData(property.edt);
            case EPC_MAXIMUM_VALUE_OF_BLOCK_PRESSURE_DATA:
                return isValidMaximumValueOfBlockPressureData(property.edt);
            case EPC_MINIMUM_VALUE_OF_BLOCK_PRESSURE_DATA:
                return isValidMinimumValueOfBlockPressureData(property.edt);
            case EPC_CURRENT_VALUE_OF_BLOCK_PRESSURE_DATA:
                return isValidCurrentValueOfBlockPressureData(property.edt);
            case EPC_NUMBER_OF_BLOCK_PRESSURE_SUPPLY_PRESSURE_ERROR_DAYS_TIME:
                return isValidNumberOfBlockPressureSupplyPressureErrorDaysTime(property.edt);
            case EPC_TEST_CALL_SETTING:
                return isValidTestCallSetting(property.edt);
            default:
                return false;
        }
    }
