...
public abstract class WaterFlowmeter extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected boolean setFlowingWaterClassification(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getFlowingWaterClassification() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setOwnerClassification(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getOwnerClassification() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getHistoricalDataOfMeasuredCumulativeAmountsOfFlowingWater() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setVerificationExpirationInformation(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getVerificationExpirationInformation() {
        return null;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_FLOWING_WATER_CLASSIFICATION:
                return setFlowingWaterClassification(property.edt);
            ...
            case EPC_VERIFICATION_EXPIRATION_INFORMATION:
                return setVerificationExpirationInformation(property.edt);
            default:
                return false;
        }
    }
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            ...
            case EPC_VERIFICATION_EXPIRATION_INFORMATION:
                return getVerificationExpirationInformation();
            default:
                return null;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_FLOWING_WATER_CLASSIFICATION:
                return isValidFlowingWaterClassification(property.edt);
            case EPC_OWNER_CLASSIFICATION:
                return isValidOwnerClassification(property.edt);
            case EPC_MEASURED_CUMULATIVE_AMOUNT_OF_FLOWING_WATER:
                return isValidMeasuredCumulativeAmountOfFlowingWater(property.edt);
            case EPC_UNIT_FOR_MEASURED_CUMULATIVE_AMOUNTS_OF_FLOWING_WATER:
                return isValidUnitForMeasuredCumulativeAmountsOfFlowingWater(property.edt);
            case EPC_HISTORICAL_DATA_OF_MEASURED_CUMULATIVE_AMOUNTS_OF_FLOWING_WATER:
                return isValidHistoricalDataOfMeasuredCumulativeAmountsOfFlowingWater(property.edt);
            case EPC_DETECTION_OF_ABNORMAL_VALUE_IN_METERING_DATA:
            ...
            case EPC_VERIFICATION_EXPIRATION_INFORMATION:
                return isValidVerificationExpirationInformation(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends WaterFlowmeter {
        ...
        @Override
        protected byte[] getMeasuredCumulativeAmountOfFlowingWater() {
            return null;
        }

        @Override
        protected byte[] getUnitForMeasuredCumulativeAmountsOfFlowingWater() {
            return null;
        }
    }
