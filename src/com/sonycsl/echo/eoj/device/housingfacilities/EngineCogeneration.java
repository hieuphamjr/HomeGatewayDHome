...
public abstract class EngineCogeneration extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected byte[] getRatedPowerGenerationOutput() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getHeatingValueOfHotWaterStorageTank() {
        return null;
    }
     ...
     * Get - undefined<br>
     */
    protected boolean setCumulativePowerGenerationOutputResetSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getMeasuredInstantaneousGasConsumption() {
        return null;
    }
     ...
     * Get - undefined<br>
     */
    protected boolean setCumulativeGasConsumptionResetSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - undefined<br>
     */
    protected boolean setPowerGenerationSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getPowerGenerationStatus() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getMeasuredInHouseInstantaneousPowerConsumption() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getMeasuredInHouseCumulativePowerConsumption() {
        return null;
    }
     ...
     * Get - undefined<br>
     */
    protected boolean setInHouseCumulativePowerConsumptionReset(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getMeasuredRemainingHotWaterAmount() {
        return null;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_CUMULATIVE_POWER_GENERATION_OUTPUT_RESET_SETTING:
                return setCumulativePowerGenerationOutputResetSetting(property.edt);
            case EPC_CUMULATIVE_GAS_CONSUMPTION_RESET_SETTING:
                return setCumulativeGasConsumptionResetSetting(property.edt);
            case EPC_POWER_GENERATION_SETTING:
                return setPowerGenerationSetting(property.edt);
            case EPC_IN_HOUSE_CUMULATIVE_POWER_CONSUMPTION_RESET:
                return setInHouseCumulativePowerConsumptionReset(property.edt);
            default:
                return false;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            ...
            case EPC_RATED_POWER_GENERATION_OUTPUT:
                return isValidRatedPowerGenerationOutput(property.edt);
            case EPC_HEATING_VALUE_OF_HOT_WATER_STORAGE_TANK:
                return isValidHeatingValueOfHotWaterStorageTank(property.edt);
            case EPC_MEASURED_INSTANTANEOUS_POWER_GENERATION_OUTPUT:
                return isValidMeasuredInstantaneousPowerGenerationOutput(property.edt);
            case EPC_MEASURED_CUMULATIVE_POWER_GENERATION_OUTPUT:
                return isValidMeasuredCumulativePowerGenerationOutput(property.edt);
            case EPC_CUMULATIVE_POWER_GENERATION_OUTPUT_RESET_SETTING:
                return isValidCumulativePowerGenerationOutputResetSetting(property.edt);
            case EPC_MEASURED_INSTANTANEOUS_GAS_CONSUMPTION:
                return isValidMeasuredInstantaneousGasConsumption(property.edt);
            case EPC_MEASURED_CUMULATIVE_GAS_CONSUMPTION:
                return isValidMeasuredCumulativeGasConsumption(property.edt);
            case EPC_CUMULATIVE_GAS_CONSUMPTION_RESET_SETTING:
                return isValidCumulativeGasConsumptionResetSetting(property.edt);
            case EPC_POWER_GENERATION_SETTING:
                return isValidPowerGenerationSetting(property.edt);
            case EPC_POWER_GENERATION_STATUS:
                return isValidPowerGenerationStatus(property.edt);
            case EPC_MEASURED_IN_HOUSE_INSTANTANEOUS_POWER_CONSUMPTION:
                return isValidMeasuredInHouseInstantaneousPowerConsumption(property.edt);
            case EPC_MEASURED_IN_HOUSE_CUMULATIVE_POWER_CONSUMPTION:
                return isValidMeasuredInHouseCumulativePowerConsumption(property.edt);
            case EPC_IN_HOUSE_CUMULATIVE_POWER_CONSUMPTION_RESET:
                return isValidInHouseCumulativePowerConsumptionReset(property.edt);
            case EPC_SYSTEM_INTERCONNECTED_TYPE:
                return isValidSystemInterconnectedType(property.edt);
            case EPC_MEASURED_REMAINING_HOT_WATER_AMOUNT:
                return isValidMeasuredRemainingHotWaterAmount(property.edt);
            case EPC_TANK_CAPACITY:
    ...
    public static class Proxy extends EngineCogeneration {
        ...
        @Override
        protected byte[] getMeasuredInstantaneousPowerGenerationOutput() {
            return null;
        }

        @Override
        protected byte[] getMeasuredCumulativePowerGenerationOutput() {
            return null;
        }
    }
