...
public abstract class ElectricVehicle extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected boolean setCumulativeDischargeElectricEnergyResetSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getCumulativeDischargeElectricEnergyResetSetting() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setCumulativeChargeElectricEnergyResetSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getCumulativeChargeElectricEnergyResetSetting() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getDeteriorationStatus() {
        return null;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_CUMULATIVE_DISCHARGE_ELECTRIC_ENERGY_RESET_SETTING:
                return setCumulativeDischargeElectricEnergyResetSetting(property.edt);
            case EPC_CUMULATIVE_CHARGE_ELECTRIC_ENERGY_RESET_SETTING:
                return setCumulativeChargeElectricEnergyResetSetting(property.edt);
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            case EPC_V2H_STORED_ELECTRICITY1:
                return getV2hStoredElectricity1();
            case EPC_V2H_STORED_ELECTRICITY2:
                return getV2hStoredElectricity2();
            case EPC_V2H_REMAINING_AVAILABLE_CAPACITY1:
                return getV2hRemainingAvailableCapacity1();
            case EPC_V2H_REMAINING_AVAILABLE_CAPACITY2:
                return getV2hRemainingAvailableCapacity2();
            case EPC_V2H_REMAINING_AVAILABLE_CAPACITY3:
                return getV2hRemainingAvailableCapacity3();
            case EPC_RATED_CHARGE_CAPACITY:
                return getRatedChargeCapacity();
            case EPC_RATED_DISCHARGE_CAPACITY:
                return getRatedDischargeCapacity();
            case EPC_CHARGEABLE_DISCHARGE_ABLE_STATUS:
                return getChargeableDischargeAbleStatus();
            ...
            case EPC_USED_CAPACITY1:
                return getUsedCapacity1();
            case EPC_USED_CAPACITY2:
                return getUsedCapacity2();
            ...
            case EPC_CUMULATIVE_DISCHARGE_ELECTRIC_ENERGY_RESET_SETTING:
                return getCumulativeDischargeElectricEnergyResetSetting();
            case EPC_MEASURED_CUMULATIVE_CHARGE_ELECTRIC_ENERGY:
                return getMeasuredCumulativeChargeElectricEnergy();
            case EPC_CUMULATIVE_CHARGE_ELECTRIC_ENERGY_RESET_SETTING:
                return getCumulativeChargeElectricEnergyResetSetting();
            case EPC_OPERATION_MODE_SETTING:
            ...
            case EPC_REMAINING_BATTERY_CAPACITY1:
                return getRemainingBatteryCapacity1();
            case EPC_REMAINING_BATTERY_CAPACITY2:
                return getRemainingBatteryCapacity2();
            case EPC_REMAINING_BATTERY_CAPACITY3:
                return getRemainingBatteryCapacity3();
            case EPC_DETERIORATION_STATUS:
                return getDeteriorationStatus();
            case EPC_CHARGING_AMOUNT_SETTING1:
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_V2H_STORED_ELECTRICITY1:
                return isValidV2hStoredElectricity1(property.edt);
            case EPC_V2H_STORED_ELECTRICITY2:
                return isValidV2hStoredElectricity2(property.edt);
            case EPC_V2H_REMAINING_AVAILABLE_CAPACITY1:
                return isValidV2hRemainingAvailableCapacity1(property.edt);
            case EPC_V2H_REMAINING_AVAILABLE_CAPACITY2:
                return isValidV2hRemainingAvailableCapacity2(property.edt);
            case EPC_V2H_REMAINING_AVAILABLE_CAPACITY3:
                return isValidV2hRemainingAvailableCapacity3(property.edt);
            case EPC_RATED_CHARGE_CAPACITY:
                return isValidRatedChargeCapacity(property.edt);
            case EPC_RATED_DISCHARGE_CAPACITY:
                return isValidRatedDischargeCapacity(property.edt);
            case EPC_CHARGEABLE_DISCHARGE_ABLE_STATUS:
                return isValidChargeableDischargeAbleStatus(property.edt);
            case EPC_MINIMUM_MAXIMUM_CHARGE_ELECTRIC_ENERGY:
            ...
            case EPC_USED_CAPACITY1:
                return isValidUsedCapacity1(property.edt);
            case EPC_USED_CAPACITY2:
                return isValidUsedCapacity2(property.edt);
            case EPC_RATED_VOLTAGE:
            ...
            case EPC_CUMULATIVE_DISCHARGE_ELECTRIC_ENERGY_RESET_SETTING:
                return isValidCumulativeDischargeElectricEnergyResetSetting(property.edt);
            case EPC_MEASURED_CUMULATIVE_CHARGE_ELECTRIC_ENERGY:
                return isValidMeasuredCumulativeChargeElectricEnergy(property.edt);
            case EPC_CUMULATIVE_CHARGE_ELECTRIC_ENERGY_RESET_SETTING:
                return isValidCumulativeChargeElectricEnergyResetSetting(property.edt);
            case EPC_OPERATION_MODE_SETTING:
                return isValidOperationModeSetting(property.edt);
            case EPC_SYSTEM_INTERCONNECTE_D_TYPE:
                return isValidSystemInterconnecteDType(property.edt);
            case EPC_REMAINING_BATTERY_CAPACITY1:
                return isValidRemainingBatteryCapacity1(property.edt);
            case EPC_REMAINING_BATTERY_CAPACITY2:
                return isValidRemainingBatteryCapacity2(property.edt);
            case EPC_REMAINING_BATTERY_CAPACITY3:
                return isValidRemainingBatteryCapacity3(property.edt);
            case EPC_DETERIORATION_STATUS:
                return isValidDeteriorationStatus(property.edt);
            case EPC_CHARGING_AMOUNT_SETTING1:
