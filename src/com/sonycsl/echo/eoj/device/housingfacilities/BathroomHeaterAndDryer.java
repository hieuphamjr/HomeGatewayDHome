...
public abstract class BathroomHeaterAndDryer extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected boolean setVentilationOperationSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getVentilationOperationSetting() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setBathroomHeaterOperationSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getBathroomHeaterOperationSetting() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setCoolAirCirculatorOperationSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getCoolAirCirculatorOperationSetting() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getMeasuredRelativeBathroomHumidity() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getMeasuredBathroomTemperature() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setFilterCleaningReminderSignSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getFilterCleaningReminderSignSetting() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getHumanBodyDetectionStatus() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setOnTimerBasedReservationSetting1(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getOnTimerBasedReservationSetting1() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setOnTimerBasedReservationSetting2(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getOnTimerBasedReservationSetting2() {
        return null;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_OPERATION_SETTING:
                return setOperationSetting(property.edt);
            case EPC_VENTILATION_OPERATION_SETTING:
                return setVentilationOperationSetting(property.edt);
            case EPC_BATHROOM_PRE_WARMER_OPERATION_SETTING:
                return setBathroomPreWarmerOperationSetting(property.edt);
            case EPC_BATHROOM_HEATER_OPERATION_SETTING:
                return setBathroomHeaterOperationSetting(property.edt);
            case EPC_BATHROOM_DRYER_OPERATION_SETTING:
                return setBathroomDryerOperationSetting(property.edt);
            case EPC_COOL_AIR_CIRCULATOR_OPERATION_SETTING:
                return setCoolAirCirculatorOperationSetting(property.edt);
            ...
            case EPC_FILTER_CLEANING_REMINDER_SIGN_SETTING:
                return setFilterCleaningReminderSignSetting(property.edt);
            case EPC_ON_TIMER_BASED_RESERVATION_SETTING1:
                return setOnTimerBasedReservationSetting1(property.edt);
            case EPC_ON_TIMER_BASED_RESERVATION_SETTING2:
                return setOnTimerBasedReservationSetting2(property.edt);
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            case EPC_OPERATION_SETTING:
                return getOperationSetting();
            case EPC_VENTILATION_OPERATION_SETTING:
                return getVentilationOperationSetting();
            case EPC_BATHROOM_PRE_WARMER_OPERATION_SETTING:
                return getBathroomPreWarmerOperationSetting();
            case EPC_BATHROOM_HEATER_OPERATION_SETTING:
                return getBathroomHeaterOperationSetting();
            case EPC_BATHROOM_DRYER_OPERATION_SETTING:
                return getBathroomDryerOperationSetting();
            case EPC_COOL_AIR_CIRCULATOR_OPERATION_SETTING:
                return getCoolAirCirculatorOperationSetting();
            case EPC_MEASURED_RELATIVE_BATHROOM_HUMIDITY:
                return getMeasuredRelativeBathroomHumidity();
            case EPC_MEASURED_BATHROOM_TEMPERATURE:
                return getMeasuredBathroomTemperature();
            case EPC_VENTILATION_AIR_FLOW_RATE_SETTING:
                return getVentilationAirFlowRateSetting();
            case EPC_FILTER_CLEANING_REMINDER_SIGN_SETTING:
                return getFilterCleaningReminderSignSetting();
            case EPC_HUMAN_BODY_DETECTION_STATUS:
                return getHumanBodyDetectionStatus();
            case EPC_ON_TIMER_BASED_RESERVATION_SETTING1:
                return getOnTimerBasedReservationSetting1();
            case EPC_ON_TIMER_BASED_RESERVATION_SETTING2:
                return getOnTimerBasedReservationSetting2();
            case EPC_ON_TIMER_SETTING_TIME:
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_OPERATION_SETTING:
                return isValidOperationSetting(property.edt);
            case EPC_VENTILATION_OPERATION_SETTING:
                return isValidVentilationOperationSetting(property.edt);
            case EPC_BATHROOM_PRE_WARMER_OPERATION_SETTING:
                return isValidBathroomPreWarmerOperationSetting(property.edt);
            case EPC_BATHROOM_HEATER_OPERATION_SETTING:
                return isValidBathroomHeaterOperationSetting(property.edt);
            case EPC_BATHROOM_DRYER_OPERATION_SETTING:
                return isValidBathroomDryerOperationSetting(property.edt);
            case EPC_COOL_AIR_CIRCULATOR_OPERATION_SETTING:
                return isValidCoolAirCirculatorOperationSetting(property.edt);
            case EPC_MEASURED_RELATIVE_BATHROOM_HUMIDITY:
                return isValidMeasuredRelativeBathroomHumidity(property.edt);
            case EPC_MEASURED_BATHROOM_TEMPERATURE:
                return isValidMeasuredBathroomTemperature(property.edt);
            case EPC_VENTILATION_AIR_FLOW_RATE_SETTING:
                return isValidVentilationAirFlowRateSetting(property.edt);
            case EPC_FILTER_CLEANING_REMINDER_SIGN_SETTING:
                return isValidFilterCleaningReminderSignSetting(property.edt);
            case EPC_HUMAN_BODY_DETECTION_STATUS:
                return isValidHumanBodyDetectionStatus(property.edt);
            case EPC_ON_TIMER_BASED_RESERVATION_SETTING1:
                return isValidOnTimerBasedReservationSetting1(property.edt);
            case EPC_ON_TIMER_BASED_RESERVATION_SETTING2:
                return isValidOnTimerBasedReservationSetting2(property.edt);
            case EPC_ON_TIMER_SETTING_TIME:
    ...
    public static class Proxy extends BathroomHeaterAndDryer {
        ...
        @Override
        protected boolean setOperationSetting(byte[] edt) {
            return false;
        }

        @Override
        protected byte[] getOperationSetting() {
            return null;
        }

        @Override
        protected boolean setBathroomPreWarmerOperationSetting(byte[] edt) {
            return false;
        }

        @Override
        protected byte[] getBathroomPreWarmerOperationSetting() {
            return null;
        }

        @Override
        protected boolean setBathroomDryerOperationSetting(byte[] edt) {
            return false;
        }

        @Override
        protected byte[] getBathroomDryerOperationSetting() {
            return null;
        }
    }
