...
public abstract class WattHourMeter extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected byte[] getIntegralElectricEnergyMeasurementLog1() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getIntegralElectricEnergyMeasurementLog2() {
        return null;
    }
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            case EPC_INTEGRAL_ELECTRIC_ENERGY_MEASUREMENT_VALUE:
                return getIntegralElectricEnergyMeasurementValue();
            case EPC_INTEGRAL_ELECTRIC_ENERGY_UNIT:
                return getIntegralElectricEnergyUnit();
            case EPC_INTEGRAL_ELECTRIC_ENERGY_MEASUREMENT_LOG1:
                return getIntegralElectricEnergyMeasurementLog1();
            case EPC_INTEGRAL_ELECTRIC_ENERGY_MEASUREMENT_LOG2:
                return getIntegralElectricEnergyMeasurementLog2();
            default:
                return null;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_INTEGRAL_ELECTRIC_ENERGY_MEASUREMENT_VALUE:
                return isValidIntegralElectricEnergyMeasurementValue(property.edt);
            case EPC_INTEGRAL_ELECTRIC_ENERGY_UNIT:
                return isValidIntegralElectricEnergyUnit(property.edt);
            case EPC_INTEGRAL_ELECTRIC_ENERGY_MEASUREMENT_LOG1:
                return isValidIntegralElectricEnergyMeasurementLog1(property.edt);
            case EPC_INTEGRAL_ELECTRIC_ENERGY_MEASUREMENT_LOG2:
                return isValidIntegralElectricEnergyMeasurementLog2(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends WattHourMeter {
        ...
        @Override
        protected byte[] getIntegralElectricEnergyMeasurementValue() {
            return null;
        }

        @Override
        protected byte[] getIntegralElectricEnergyUnit() {
            return null;
        }
    }
