...
public abstract class FloorHeater extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected byte[] getMeasuredRoomTemperature() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getMeasuredFloorTemperature() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setZoneChangeSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getZoneChangeSetting() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setTimeSetByOnTimer(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getTimeSetByOnTimer() {
        return null;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            ...
            case EPC_ZONE_CHANGE_SETTING:
                return setZoneChangeSetting(property.edt);
            ...
            case EPC_TIME_SET_BY_ON_TIMER:
                return setTimeSetByOnTimer(property.edt);
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            ...
            case EPC_MEASURED_ROOM_TEMPERATURE:
                return getMeasuredRoomTemperature();
            case EPC_MEASURED_FLOOR_TEMPERATURE:
                return getMeasuredFloorTemperature();
            case EPC_ZONE_CHANGE_SETTING:
                return getZoneChangeSetting();
            case EPC_SPECIAL_OPERATION_SETTING:
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            ...
            case EPC_MEASURED_ROOM_TEMPERATURE:
                return isValidMeasuredRoomTemperature(property.edt);
            case EPC_MEASURED_FLOOR_TEMPERATURE:
                return isValidMeasuredFloorTemperature(property.edt);
            case EPC_ZONE_CHANGE_SETTING:
                return isValidZoneChangeSetting(property.edt);
            case EPC_SPECIAL_OPERATION_SETTING:
            ...
            case EPC_TIME_SET_BY_ON_TIMER:
                return isValidTimeSetByOnTimer(property.edt);
            case EPC_RELATIVE_ON_TIMER_SETTING:
