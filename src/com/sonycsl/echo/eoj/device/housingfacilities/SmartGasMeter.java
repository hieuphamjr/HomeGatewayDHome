...
public abstract class SmartGasMeter extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected boolean setGasMeterClassificationSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getGasMeterClassificationSetting() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setOwnerClassificationSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getOwnerClassificationSetting() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getUnitForMeasuredCumulativeGasConsumption() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getHistoricalDataOfMeasuredCumulativeGasConsumption() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setDaySettingForWhichTheHistoricalDataOfMeasuredCumulativeGasConsumptionIsToBeRetrieved(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getDaySettingForWhichTheHistoricalDataOfMeasuredCumulativeGasConsumptionIsToBeRetrieved() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getDetectionOfAbnormalValueInMeteringData() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getSecurityDataInformation() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getValveClosureByTheCenter() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getPermissionFromTheCenterToReopenTheValveClosedByTheCenter() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getEmergencyClosureOfShutoffValve() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getShutoffValveStatus() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getHistoricalDataOfShutoffReasons() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setIdNumberSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getIdNumberSetting() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setVerificationExpirationSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getVerificationExpirationSetting() {
        return null;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_GAS_METER_CLASSIFICATION_SETTING:
                return setGasMeterClassificationSetting(property.edt);
            case EPC_OWNER_CLASSIFICATION_SETTING:
                return setOwnerClassificationSetting(property.edt);
            case EPC_DAY_SETTING_FOR_WHICH_THE_HISTORICAL_DATA_OF_MEASURED_CUMULATIVE_GAS_CONSUMPTION_IS_TO_BE_RETRIEVED:
                return setDaySettingForWhichTheHistoricalDataOfMeasuredCumulativeGasConsumptionIsToBeRetrieved(property.edt);
            case EPC_ID_NUMBER_SETTING:
                return setIdNumberSetting(property.edt);
            case EPC_VERIFICATION_EXPIRATION_SETTING:
                return setVerificationExpirationSetting(property.edt);
            default:
                return false;
        }
    }
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            case EPC_GAS_METER_CLASSIFICATION_SETTING:
                return getGasMeterClassificationSetting();
            case EPC_OWNER_CLASSIFICATION_SETTING:
                return getOwnerClassificationSetting();
            case EPC_MEASURED_CUMULATIVE_GAS_CONSUMPTION:
                return getMeasuredCumulativeGasConsumption();
            case EPC_UNIT_FOR_MEASURED_CUMULATIVE_GAS_CONSUMPTION:
                return getUnitForMeasuredCumulativeGasConsumption();
            case EPC_HISTORICAL_DATA_OF_MEASURED_CUMULATIVE_GAS_CONSUMPTION:
                return getHistoricalDataOfMeasuredCumulativeGasConsumption();
            case EPC_DAY_SETTING_FOR_WHICH_THE_HISTORICAL_DATA_OF_MEASURED_CUMULATIVE_GAS_CONSUMPTION_IS_TO_BE_RETRIEVED:
                return getDaySettingForWhichTheHistoricalDataOfMeasuredCumulativeGasConsumptionIsToBeRetrieved();
            case EPC_DETECTION_OF_ABNORMAL_VALUE_IN_METERING_DATA:
                return getDetectionOfAbnormalValueInMeteringData();
            case EPC_SECURITY_DATA_INFORMATION:
                return getSecurityDataInformation();
            case EPC_VALVE_CLOSURE_BY_THE_CENTER:
                return getValveClosureByTheCenter();
            case EPC_PERMISSION_FROM_THE_CENTER_TO_REOPEN_THE_VALVE_CLOSED_BY_THE_CENTER:
                return getPermissionFromTheCenterToReopenTheValveClosedByTheCenter();
            case EPC_EMERGENCY_CLOSURE_OF_SHUTOFF_VALVE:
                return getEmergencyClosureOfShutoffValve();
            case EPC_SHUTOFF_VALVE_STATUS:
                return getShutoffValveStatus();
            case EPC_HISTORICAL_DATA_OF_SHUTOFF_REASONS:
                return getHistoricalDataOfShutoffReasons();
            case EPC_ID_NUMBER_SETTING:
                return getIdNumberSetting();
            case EPC_VERIFICATION_EXPIRATION_SETTING:
                return getVerificationExpirationSetting();
            case EPC_MEASURED_CUMULATIVE_GAS_CONSUMPTION_INFORMATION_WITH_DATE_AND_TIME:
                return getMeasuredCumulativeGasConsumptionInformationWithDateAndTime();
            default:
                return null;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_GAS_METER_CLASSIFICATION_SETTING:
                return isValidGasMeterClassificationSetting(property.edt);
            case EPC_OWNER_CLASSIFICATION_SETTING:
                return isValidOwnerClassificationSetting(property.edt);
            case EPC_MEASURED_CUMULATIVE_GAS_CONSUMPTION:
                return isValidMeasuredCumulativeGasConsumption(property.edt);
            case EPC_UNIT_FOR_MEASURED_CUMULATIVE_GAS_CONSUMPTION:
                return isValidUnitForMeasuredCumulativeGasConsumption(property.edt);
            case EPC_HISTORICAL_DATA_OF_MEASURED_CUMULATIVE_GAS_CONSUMPTION:
                return isValidHistoricalDataOfMeasuredCumulativeGasConsumption(property.edt);
            case EPC_DAY_SETTING_FOR_WHICH_THE_HISTORICAL_DATA_OF_MEASURED_CUMULATIVE_GAS_CONSUMPTION_IS_TO_BE_RETRIEVED:
                return isValidDaySettingForWhichTheHistoricalDataOfMeasuredCumulativeGasConsumptionIsToBeRetrieved(property.edt);
            case EPC_DETECTION_OF_ABNORMAL_VALUE_IN_METERING_DATA:
                return isValidDetectionOfAbnormalValueInMeteringData(property.edt);
            case EPC_SECURITY_DATA_INFORMATION:
                return isValidSecurityDataInformation(property.edt);
            case EPC_VALVE_CLOSURE_BY_THE_CENTER:
                return isValidValveClosureByTheCenter(property.edt);
            case EPC_PERMISSION_FROM_THE_CENTER_TO_REOPEN_THE_VALVE_CLOSED_BY_THE_CENTER:
                return isValidPermissionFromTheCenterToReopenTheValveClosedByTheCenter(property.edt);
            case EPC_EMERGENCY_CLOSURE_OF_SHUTOFF_VALVE:
                return isValidEmergencyClosureOfShutoffValve(property.edt);
            case EPC_SHUTOFF_VALVE_STATUS:
                return isValidShutoffValveStatus(property.edt);
            case EPC_HISTORICAL_DATA_OF_SHUTOFF_REASONS:
                return isValidHistoricalDataOfShutoffReasons(property.edt);
            case EPC_ID_NUMBER_SETTING:
                return isValidIdNumberSetting(property.edt);
            case EPC_VERIFICATION_EXPIRATION_SETTING:
                return isValidVerificationExpirationSetting(property.edt);
            case EPC_MEASURED_CUMULATIVE_GAS_CONSUMPTION_INFORMATION_WITH_DATE_AND_TIME:
                return isValidMeasuredCumulativeGasConsumptionInformationWithDateAndTime(property.edt);
            case EPC_HISTORICAL_INFORMATION_OF_CUMULATIVE_GAS_CONSUMPTION:
                return isValidHistoricalInformationOfCumulativeGasConsumption(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends SmartGasMeter {
        ...
        @Override
        protected byte[] getMeasuredCumulativeGasConsumption() {
            return null;
        }

        @Override
        protected byte[] getMeasuredCumulativeGasConsumptionInformationWithDateAndTime() {
            return null;
        }
    }
