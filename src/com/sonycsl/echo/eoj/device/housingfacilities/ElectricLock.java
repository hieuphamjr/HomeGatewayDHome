...
public abstract class ElectricLock extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected boolean setLockSetting2(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getLockSetting2() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getLockStatusOfDoorGuard() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getOccupantNonOccupantStatus() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setAutoLockModeSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getAutoLockModeSetting() {
        return null;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_LOCK_SETTING1:
                return setLockSetting1(property.edt);
            case EPC_LOCK_SETTING2:
                return setLockSetting2(property.edt);
            case EPC_AUTO_LOCK_MODE_SETTING:
                return setAutoLockModeSetting(property.edt);
            default:
                return false;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_LOCK_SETTING1:
                return isValidLockSetting1(property.edt);
            case EPC_LOCK_SETTING2:
                return isValidLockSetting2(property.edt);
            case EPC_LOCK_STATUS_OF_DOOR_GUARD:
                return isValidLockStatusOfDoorGuard(property.edt);
            case EPC_DOOR_OPEN_CLOSE_STATUS:
                return isValidDoorOpenCloseStatus(property.edt);
            case EPC_OCCUPANT_NON_OCCUPANT_STATUS:
                return isValidOccupantNonOccupantStatus(property.edt);
            case EPC_ALARM_STATUS:
                return isValidAlarmStatus(property.edt);
            case EPC_AUTO_LOCK_MODE_SETTING:
                return isValidAutoLockModeSetting(property.edt);
            default:
                return false;
        }
    }
