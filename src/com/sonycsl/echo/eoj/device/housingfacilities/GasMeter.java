...
public abstract class GasMeter extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected byte[] getIntegralGasConsumptionMeasurementLog() {
        return null;
    }
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            case EPC_INTEGRAL_GAS_CONSUMPTION_MEASUREMENT_VALUE:
                return getIntegralGasConsumptionMeasurementValue();
            case EPC_INTEGRAL_GAS_CONSUMPTION_MEASUREMENT_LOG:
                return getIntegralGasConsumptionMeasurementLog();
            default:
                return null;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_INTEGRAL_GAS_CONSUMPTION_MEASUREMENT_VALUE:
                return isValidIntegralGasConsumptionMeasurementValue(property.edt);
            case EPC_INTEGRAL_GAS_CONSUMPTION_MEASUREMENT_LOG:
                return isValidIntegralGasConsumptionMeasurementLog(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends GasMeter {
        ...
        @Override
        protected byte[] getIntegralGasConsumptionMeasurementValue() {
            return null;
        }
    }
