...
public abstract class Sprinkler extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected boolean setSprinkleIntervalSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getSprinkleIntervalSetting() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setNumberOfSprinklesSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getNumberOfSprinklesSetting() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setSprinkleTimeSetting1(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getSprinkleTimeSetting1() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setSprinkleTimeSetting2(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getSprinkleTimeSetting2() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setSprinkleDurationSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getSprinkleDurationSetting() {
        return null;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_SPRINKLE_VALVE_OPEN_CLOSE_SETTING:
                return setSprinkleValveOpenCloseSetting(property.edt);
            case EPC_SPRINKLE_INTERVAL_SETTING:
                return setSprinkleIntervalSetting(property.edt);
            case EPC_NUMBER_OF_SPRINKLES_SETTING:
                return setNumberOfSprinklesSetting(property.edt);
            case EPC_SPRINKLE_TIME_SETTING1:
                return setSprinkleTimeSetting1(property.edt);
            case EPC_SPRINKLE_TIME_SETTING2:
                return setSprinkleTimeSetting2(property.edt);
            case EPC_SPRINKLE_DURATION_SETTING:
                return setSprinkleDurationSetting(property.edt);
            default:
                return false;
        }
    }
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            case EPC_SPRINKLE_VALVE_OPEN_CLOSE_SETTING:
                return getSprinkleValveOpenCloseSetting();
            case EPC_SPRINKLE_INTERVAL_SETTING:
                return getSprinkleIntervalSetting();
            case EPC_NUMBER_OF_SPRINKLES_SETTING:
                return getNumberOfSprinklesSetting();
            case EPC_SPRINKLE_TIME_SETTING1:
                return getSprinkleTimeSetting1();
            case EPC_SPRINKLE_TIME_SETTING2:
                return getSprinkleTimeSetting2();
            case EPC_SPRINKLE_DURATION_SETTING:
                return getSprinkleDurationSetting();
            default:
                return null;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_SPRINKLE_VALVE_OPEN_CLOSE_SETTING:
                return isValidSprinkleValveOpenCloseSetting(property.edt);
            case EPC_SPRINKLE_INTERVAL_SETTING:
                return isValidSprinkleIntervalSetting(property.edt);
            case EPC_NUMBER_OF_SPRINKLES_SETTING:
                return isValidNumberOfSprinklesSetting(property.edt);
            case EPC_SPRINKLE_TIME_SETTING1:
                return isValidSprinkleTimeSetting1(property.edt);
            case EPC_SPRINKLE_TIME_SETTING2:
                return isValidSprinkleTimeSetting2(property.edt);
            case EPC_SPRINKLE_DURATION_SETTING:
                return isValidSprinkleDurationSetting(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends Sprinkler {
        ...
        @Override
        protected boolean setSprinkleValveOpenCloseSetting(byte[] edt) {
            return false;
        }

        @Override
        protected byte[] getSprinkleValveOpenCloseSetting() {
            return null;
        }
    }
