...
public abstract class ElectricToiletSeat extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected boolean setTemperatureLevelOfToiletSeat(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setTemporalHaltSettingOfToiletSeat(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setTemporalHaltStartTimeOfToiletSeat(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setTemporalHaltTimeDurationOfToiletSeat(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setTemperatureLevelSettingOfRoomHeating(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setRoomHeatingSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setStartTimeOfRoomHeating(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setDurationTimeOfRoomHeating(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setSpecialOperationModeSetting(byte[] edt) {
        return false;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_TEMPERATURE_LEVEL_OF_TOILET_SEAT:
                return setTemperatureLevelOfToiletSeat(property.edt);
            case EPC_HEATER_SETTING_OF_TOILET_SEAT:
                return setHeaterSettingOfToiletSeat(property.edt);
            case EPC_TEMPORAL_HALT_SETTING_OF_TOILET_SEAT:
                return setTemporalHaltSettingOfToiletSeat(property.edt);
            case EPC_TEMPORAL_HALT_START_TIME_OF_TOILET_SEAT:
                return setTemporalHaltStartTimeOfToiletSeat(property.edt);
            case EPC_TEMPORAL_HALT_TIME_DURATION_OF_TOILET_SEAT:
                return setTemporalHaltTimeDurationOfToiletSeat(property.edt);
            case EPC_TEMPERATURE_LEVEL_SETTING_OF_ROOM_HEATING:
                return setTemperatureLevelSettingOfRoomHeating(property.edt);
            case EPC_ROOM_HEATING_SETTING:
                return setRoomHeatingSetting(property.edt);
            case EPC_START_TIME_OF_ROOM_HEATING:
                return setStartTimeOfRoomHeating(property.edt);
            case EPC_DURATION_TIME_OF_ROOM_HEATING:
                return setDurationTimeOfRoomHeating(property.edt);
            case EPC_SPECIAL_OPERATION_MODE_SETTING:
                return setSpecialOperationModeSetting(property.edt);
            default:
                return false;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_TEMPERATURE_LEVEL_OF_TOILET_SEAT:
                return isValidTemperatureLevelOfToiletSeat(property.edt);
            case EPC_HEATER_SETTING_OF_TOILET_SEAT:
                return isValidHeaterSettingOfToiletSeat(property.edt);
            case EPC_TEMPORAL_HALT_SETTING_OF_TOILET_SEAT:
                return isValidTemporalHaltSettingOfToiletSeat(property.edt);
            case EPC_TEMPORAL_HALT_START_TIME_OF_TOILET_SEAT:
                return isValidTemporalHaltStartTimeOfToiletSeat(property.edt);
            case EPC_TEMPORAL_HALT_TIME_DURATION_OF_TOILET_SEAT:
                return isValidTemporalHaltTimeDurationOfToiletSeat(property.edt);
            case EPC_TEMPERATURE_LEVEL_SETTING_OF_ROOM_HEATING:
                return isValidTemperatureLevelSettingOfRoomHeating(property.edt);
            case EPC_ROOM_HEATING_SETTING:
                return isValidRoomHeatingSetting(property.edt);
            case EPC_ROOM_HEATING_STATUS:
                return isValidRoomHeatingStatus(property.edt);
            case EPC_START_TIME_OF_ROOM_HEATING:
                return isValidStartTimeOfRoomHeating(property.edt);
            case EPC_DURATION_TIME_OF_ROOM_HEATING:
                return isValidDurationTimeOfRoomHeating(property.edt);
            case EPC_SPECIAL_OPERATION_MODE_SETTING:
                return isValidSpecialOperationModeSetting(property.edt);
            case EPC_HUMAN_DETECTION_STATUS:
                return isValidHumanDetectionStatus(property.edt);
            case EPC_SEATING_DETECTION_STATUS:
                return isValidSeatingDetectionStatus(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends ElectricToiletSeat {
        ...
        @Override
        protected boolean setHeaterSettingOfToiletSeat(byte[] edt) {
            return false;
        }
