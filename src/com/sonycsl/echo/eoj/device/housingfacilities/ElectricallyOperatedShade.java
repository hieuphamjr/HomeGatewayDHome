...
public abstract class ElectricallyOperatedShade extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected boolean setSetValueOfShadeAngle(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getSetValueOfShadeAngle() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setShadeOpenCloseSpeed(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getShadeOpenCloseSpeed() {
        return null;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_OPEN_CLOSE_SETTING:
                return setOpenCloseSetting(property.edt);
            case EPC_DEGREE_OF_OPENI_NG_LEVEL:
                return setDegreeOfOpeniNgLevel(property.edt);
            case EPC_SET_VALUE_OF_SHADE_ANGLE:
                return setSetValueOfShadeAngle(property.edt);
            case EPC_SHADE_OPEN_CLOSE_SPEED:
                return setShadeOpenCloseSpeed(property.edt);
            default:
                return false;
        }
    }
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            case EPC_OPEN_CLOSE_SETTING:
                return getOpenCloseSetting();
            case EPC_DEGREE_OF_OPENI_NG_LEVEL:
                return getDegreeOfOpeniNgLevel();
            case EPC_SET_VALUE_OF_SHADE_ANGLE:
                return getSetValueOfShadeAngle();
            case EPC_SHADE_OPEN_CLOSE_SPEED:
                return getShadeOpenCloseSpeed();
            default:
                return null;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_OPEN_CLOSE_SETTING:
                return isValidOpenCloseSetting(property.edt);
            case EPC_DEGREE_OF_OPENI_NG_LEVEL:
                return isValidDegreeOfOpeniNgLevel(property.edt);
            case EPC_SET_VALUE_OF_SHADE_ANGLE:
                return isValidSetValueOfShadeAngle(property.edt);
            case EPC_SHADE_OPEN_CLOSE_SPEED:
                return isValidShadeOpenCloseSpeed(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends ElectricallyOperatedShade {
        ...
        @Override
        protected byte[] getOpenCloseSetting() {
            return null;
        }

        @Override
        protected boolean setDegreeOfOpeniNgLevel(byte[] edt) {
            return false;
        }

        @Override
        protected byte[] getDegreeOfOpeniNgLevel() {
            return null;
        }
    }
