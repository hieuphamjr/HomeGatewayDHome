...
public abstract class ColdOrHotWaterHeatSourceEquipment extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected byte[] getMeasuredTemperatureOfOutwardWaterExitWaterTemperature() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getMeasuredTemperatureOfInwardWaterEntranceWaterTemperature() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setSpecialOperationSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getSpecialOperationSetting() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setDailyTimerSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getDailyTimerSetting() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setDailyTimerSetting1(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getDailyTimerSetting1() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setDailyTimerSetting2(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getDailyTimerSetting2() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setRelativeOnTimerSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getRelativeOnTimerSetting() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setTimeSetByOffTimer(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getTimeSetByOffTimer() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setRelativeOffTimerSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getRelativeOffTimerSetting() {
        return null;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            ...
            case EPC_WATER_TEMPERATURE_SETTING1:
                return setWaterTemperatureSetting1(property.edt);
            case EPC_WATER_TEMPERATURE_SETTING2:
                return setWaterTemperatureSetting2(property.edt);
            case EPC_SPECIAL_OPERATION_SETTING:
                return setSpecialOperationSetting(property.edt);
            case EPC_DAILY_TIMER_SETTING:
                return setDailyTimerSetting(property.edt);
            case EPC_DAILY_TIMER_SETTING1:
                return setDailyTimerSetting1(property.edt);
            case EPC_DAILY_TIMER_SETTING2:
                return setDailyTimerSetting2(property.edt);
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            ...
            case EPC_WATER_TEMPERATURE_SETTING1:
                return getWaterTemperatureSetting1();
            case EPC_WATER_TEMPERATURE_SETTING2:
                return getWaterTemperatureSetting2();
            case EPC_MEASURED_TEMPERATURE_OF_OUTWARD_WATER_EXIT_WATER_TEMPERATURE:
                return getMeasuredTemperatureOfOutwardWaterExitWaterTemperature();
            case EPC_MEASURED_TEMPERATURE_OF_INWARD_WATER_ENTRANCE_WATER_TEMPERATURE:
                return getMeasuredTemperatureOfInwardWaterEntranceWaterTemperature();
            case EPC_SPECIAL_OPERATION_SETTING:
                return getSpecialOperationSetting();
            case EPC_DAILY_TIMER_SETTING:
                return getDailyTimerSetting();
            case EPC_DAILY_TIMER_SETTING1:
                return getDailyTimerSetting1();
            case EPC_DAILY_TIMER_SETTING2:
                return getDailyTimerSetting2();
            case EPC_ON_TIMER_RESERVATION_SETTING:
                return getOnTimerReservationSetting();
            case EPC_ON_TIMER_SETTING:
                return getOnTimerSetting();
            case EPC_RELATIVE_ON_TIMER_SETTING:
                return getRelativeOnTimerSetting();
            case EPC_OFF_TIMER_RESERVATION_SETTING:
                return getOffTimerReservationSetting();
            case EPC_TIME_SET_BY_OFF_TIMER:
                return getTimeSetByOffTimer();
            case EPC_RELATIVE_OFF_TIMER_SETTING:
                return getRelativeOffTimerSetting();
            default:
                return null;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            ...
            case EPC_WATER_TEMPERATURE_SETTING1:
                return isValidWaterTemperatureSetting1(property.edt);
            case EPC_WATER_TEMPERATURE_SETTING2:
                return isValidWaterTemperatureSetting2(property.edt);
            case EPC_MEASURED_TEMPERATURE_OF_OUTWARD_WATER_EXIT_WATER_TEMPERATURE:
                return isValidMeasuredTemperatureOfOutwardWaterExitWaterTemperature(property.edt);
            case EPC_MEASURED_TEMPERATURE_OF_INWARD_WATER_ENTRANCE_WATER_TEMPERATURE:
                return isValidMeasuredTemperatureOfInwardWaterEntranceWaterTemperature(property.edt);
            case EPC_SPECIAL_OPERATION_SETTING:
                return isValidSpecialOperationSetting(property.edt);
            case EPC_DAILY_TIMER_SETTING:
                return isValidDailyTimerSetting(property.edt);
            case EPC_DAILY_TIMER_SETTING1:
                return isValidDailyTimerSetting1(property.edt);
            case EPC_DAILY_TIMER_SETTING2:
                return isValidDailyTimerSetting2(property.edt);
            case EPC_ON_TIMER_RESERVATION_SETTING:
                return isValidOnTimerReservationSetting(property.edt);
            case EPC_ON_TIMER_SETTING:
                return isValidOnTimerSetting(property.edt);
            case EPC_RELATIVE_ON_TIMER_SETTING:
                return isValidRelativeOnTimerSetting(property.edt);
            case EPC_OFF_TIMER_RESERVATION_SETTING:
                return isValidOffTimerReservationSetting(property.edt);
            case EPC_TIME_SET_BY_OFF_TIMER:
                return isValidTimeSetByOffTimer(property.edt);
            case EPC_RELATIVE_OFF_TIMER_SETTING:
                return isValidRelativeOffTimerSetting(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends ColdOrHotWaterHeatSourceEquipment {
        ...
        @Override
        protected boolean setWaterTemperatureSetting1(byte[] edt) {
            return false;
        }

        @Override
        protected byte[] getWaterTemperatureSetting1() {
            return null;
        }

        @Override
        protected boolean setWaterTemperatureSetting2(byte[] edt) {
            return false;
        }

        @Override
        protected byte[] getWaterTemperatureSetting2() {
            return null;
        }
    }
