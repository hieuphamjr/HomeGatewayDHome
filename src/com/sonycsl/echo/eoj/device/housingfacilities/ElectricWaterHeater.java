...
public abstract class ElectricWaterHeater extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected boolean setAutomaticWaterTemperatureControlSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setDaytimeReheatingPermissionSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setTemperatureOfSuppliedWaterSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setBathWaterTemperatureSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setBathWaterVolumeSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setAdditionOfHotWaterFunctionSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setSlightBathWaterTemperatureLoweringFunctionSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setBathWaterVolumeSetting1(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setBathWaterVolumeSetting2(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setBathWaterVolumeSetting3(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setBathWaterVolumeSetting4(byte[] edt) {
        return false;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_AUTOMATIC_WATER_HEATING_SETTING:
                return setAutomaticWaterHeatingSetting(property.edt);
            case EPC_AUTOMATIC_WATER_TEMPERATURE_CONTROL_SETTING:
                return setAutomaticWaterTemperatureControlSetting(property.edt);
            case EPC_WATER_HEATING_TEMPERATURE_SETTING:
                return setWaterHeatingTemperatureSetting(property.edt);
            case EPC_DAYTIME_REHEATING_PERMISSION_SETTING:
                return setDaytimeReheatingPermissionSetting(property.edt);
            case EPC_TEMPERATURE_OF_SUPPLIED_WATER_SETTING:
                return setTemperatureOfSuppliedWaterSetting(property.edt);
            case EPC_BATH_WATER_TEMPERATURE_SETTING:
                return setBathWaterTemperatureSetting(property.edt);
            case EPC_BATH_WATER_VOLUME_SETTING:
                return setBathWaterVolumeSetting(property.edt);
            case EPC_AUTOMATIC_BATH_WATER_HEATING_MODE_SETTING:
                return setAutomaticBathWaterHeatingModeSetting(property.edt);
            case EPC_ADDITION_OF_HOT_WATER_FUNCTION_SETTING:
                return setAdditionOfHotWaterFunctionSetting(property.edt);
            case EPC_SLIGHT_BATH_WATER_TEMPERATURE_LOWERING_FUNCTION_SETTING:
                return setSlightBathWaterTemperatureLoweringFunctionSetting(property.edt);
            case EPC_BATH_WATER_VOLUME_SETTING1:
                return setBathWaterVolumeSetting1(property.edt);
            case EPC_BATH_WATER_VOLUME_SETTING2:
                return setBathWaterVolumeSetting2(property.edt);
            case EPC_BATH_WATER_VOLUME_SETTING3:
                return setBathWaterVolumeSetting3(property.edt);
            case EPC_BATH_WATER_VOLUME_SETTING4:
                return setBathWaterVolumeSetting4(property.edt);
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_AUTOMATIC_WATER_HEATING_SETTING:
                return isValidAutomaticWaterHeatingSetting(property.edt);
            case EPC_AUTOMATIC_WATER_TEMPERATURE_CONTROL_SETTING:
                return isValidAutomaticWaterTemperatureControlSetting(property.edt);
            case EPC_WATER_HEATER_STATUS:
                return isValidWaterHeaterStatus(property.edt);
            case EPC_WATER_HEATING_TEMPERATURE_SETTING:
                return isValidWaterHeatingTemperatureSetting(property.edt);
            case EPC_DAYTIME_REHEATING_PERMISSION_SETTING:
                return isValidDaytimeReheatingPermissionSetting(property.edt);
            case EPC_MEASURED_TEMPERATURE_OF_WATER_IN_WATER_HEATER:
                return isValidMeasuredTemperatureOfWaterInWaterHeater(property.edt);
            case EPC_ALARM_STATUS:
                return isValidAlarmStatus(property.edt);
            case EPC_TEMPERATURE_OF_SUPPLIED_WATER_SETTING:
                return isValidTemperatureOfSuppliedWaterSetting(property.edt);
            case EPC_BATH_WATER_TEMPERATURE_SETTING:
                return isValidBathWaterTemperatureSetting(property.edt);
            case EPC_BATH_WATER_VOLUME_SETTING:
                return isValidBathWaterVolumeSetting(property.edt);
            case EPC_MEASURED_AMOUNT_OF_WATER_REMAINING_IN_TANK:
                return isValidMeasuredAmountOfWaterRemainingInTank(property.edt);
            case EPC_TANK_CAPACITY:
                return isValidTankCapacity(property.edt);
            case EPC_AUTOMATIC_BATH_WATER_HEATING_MODE_SETTING:
                return isValidAutomaticBathWaterHeatingModeSetting(property.edt);
            case EPC_ADDITION_OF_HOT_WATER_FUNCTION_SETTING:
                return isValidAdditionOfHotWaterFunctionSetting(property.edt);
            case EPC_SLIGHT_BATH_WATER_TEMPERATURE_LOWERING_FUNCTION_SETTING:
                return isValidSlightBathWaterTemperatureLoweringFunctionSetting(property.edt);
            case EPC_BATH_WATER_VOLUME_SETTING1:
                return isValidBathWaterVolumeSetting1(property.edt);
            case EPC_BATH_WATER_VOLUME_SETTING2:
                return isValidBathWaterVolumeSetting2(property.edt);
            case EPC_BATH_WATER_VOLUME_SETTING3:
                return isValidBathWaterVolumeSetting3(property.edt);
            case EPC_BATH_WATER_VOLUME_SETTING4:
                return isValidBathWaterVolumeSetting4(property.edt);
            case EPC_BATH_WATER_VOLUME_SETTING4_MAXIMUM_SETTABLE_LEVEL:
                return isValidBathWaterVolumeSetting4MaximumSettableLevel(property.edt);
            case EPC_ON_TIMER_RESERVATION_SETTING:
                return isValidOnTimerReservationSetting(property.edt);
            case EPC_ON_TIMER_SETTING:
                return isValidOnTimerSetting(property.edt);
            case EPC_RATED_POWER_CONSUMPTION_OF_H_P_UNIT_IN_WINTERTIME:
                return isValidRatedPowerConsumptionOfHPUnitInWintertime(property.edt);
            case EPC_RATED_POWER_CONSUMPTION_OF_H_P_UNIT_IN_IN_BETWEEN_SEASONS:
                return isValidRatedPowerConsumptionOfHPUnitInInBetweenSeasons(property.edt);
            case EPC_RATED_POWER_CONSUMPTION_OF_H_P_UNIT_IN_SUMMERTIME:
                return isValidRatedPowerConsumptionOfHPUnitInSummertime(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends ElectricWaterHeater {
        ...
        @Override
        protected boolean setAutomaticWaterHeatingSetting(byte[] edt) {
            return false;
        }
        ...
        @Override
        protected boolean setWaterHeatingTemperatureSetting(byte[] edt) {
            return false;
        }
        ...
        @Override
        protected boolean setAutomaticBathWaterHeatingModeSetting(byte[] edt) {
            return false;
        }
