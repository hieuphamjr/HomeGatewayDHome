...
public abstract class FanHeater extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected byte[] getMeasuredTemperature() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setOnTimerSettingValueTime(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getOnTimerSettingValueTime() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setOnTimerSettingValueRelativeTime(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getOnTimerSettingValueRelativeTime() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setOffTimerSettingValueTime(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getOffTimerSettingValueTime() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setOffTimerValueRelativeTime(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getOffTimerValueRelativeTime() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setExtentionalOperationSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getExtentionalOperationSetting() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setExtentionalOperationTimerTimeSettingValue(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getExtentionalOperationTimerTimeSettingValue() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setIonEmissionSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getIonEmissionSetting() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getImplementedIonEmissionMethod() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getOilAmountLevel() {
        return null;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_TEMPERATURE_SETTING_VALUE:
                return setTemperatureSettingValue(property.edt);
            ...
            case EPC_ON_TIMER_SETTING_VALUE_TIME:
                return setOnTimerSettingValueTime(property.edt);
            case EPC_ON_TIMER_SETTING_VALUE_RELATIVE_TIME:
                return setOnTimerSettingValueRelativeTime(property.edt);
            ...
            case EPC_OFF_TIMER_SETTING_VALUE_TIME:
                return setOffTimerSettingValueTime(property.edt);
            case EPC_OFF_TIMER_VALUE_RELATIVE_TIME:
                return setOffTimerValueRelativeTime(property.edt);
            case EPC_EXTENTIONAL_OPERATION_SETTING:
                return setExtentionalOperationSetting(property.edt);
            case EPC_EXTENTIONAL_OPERATION_TIMER_TIME_SETTING_VALUE:
                return setExtentionalOperationTimerTimeSettingValue(property.edt);
            case EPC_ION_EMISSION_SETTING:
                return setIonEmissionSetting(property.edt);
            default:
                return false;
        }
    }
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            case EPC_TEMPERATURE_SETTING_VALUE:
                return getTemperatureSettingValue();
            case EPC_MEASURED_TEMPERATURE:
                return getMeasuredTemperature();
            case EPC_AUTOMATIC_TEMPERATURE_CONTROL_SETTING:
                return getAutomaticTemperatureControlSetting();
            case EPC_ON_TIMER_RESERVATION_SETTING:
                return getOnTimerReservationSetting();
            case EPC_ON_TIMER_SETTING_VALUE_TIME:
                return getOnTimerSettingValueTime();
            case EPC_ON_TIMER_SETTING_VALUE_RELATIVE_TIME:
                return getOnTimerSettingValueRelativeTime();
            case EPC_OFF_TIMER_RESERVATION_SETTING:
                return getOffTimerReservationSetting();
            case EPC_OFF_TIMER_SETTING_VALUE_TIME:
                return getOffTimerSettingValueTime();
            case EPC_OFF_TIMER_VALUE_RELATIVE_TIME:
                return getOffTimerValueRelativeTime();
            case EPC_EXTENTIONAL_OPERATION_SETTING:
                return getExtentionalOperationSetting();
            case EPC_EXTENTIONAL_OPERATION_TIMER_TIME_SETTING_VALUE:
                return getExtentionalOperationTimerTimeSettingValue();
            case EPC_ION_EMISSION_SETTING:
                return getIonEmissionSetting();
            case EPC_IMPLEMENTED_ION_EMISSION_METHOD:
                return getImplementedIonEmissionMethod();
            case EPC_OIL_AMOUNT_LEVEL:
                return getOilAmountLevel();
            default:
                return null;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_TEMPERATURE_SETTING_VALUE:
                return isValidTemperatureSettingValue(property.edt);
            case EPC_MEASURED_TEMPERATURE:
                return isValidMeasuredTemperature(property.edt);
            case EPC_AUTOMATIC_TEMPERATURE_CONTROL_SETTING:
                return isValidAutomaticTemperatureControlSetting(property.edt);
            case EPC_ON_TIMER_RESERVATION_SETTING:
                return isValidOnTimerReservationSetting(property.edt);
            case EPC_ON_TIMER_SETTING_VALUE_TIME:
                return isValidOnTimerSettingValueTime(property.edt);
            case EPC_ON_TIMER_SETTING_VALUE_RELATIVE_TIME:
                return isValidOnTimerSettingValueRelativeTime(property.edt);
            case EPC_OFF_TIMER_RESERVATION_SETTING:
                return isValidOffTimerReservationSetting(property.edt);
            case EPC_OFF_TIMER_SETTING_VALUE_TIME:
                return isValidOffTimerSettingValueTime(property.edt);
            case EPC_OFF_TIMER_VALUE_RELATIVE_TIME:
                return isValidOffTimerValueRelativeTime(property.edt);
            case EPC_EXTENTIONAL_OPERATION_SETTING:
                return isValidExtentionalOperationSetting(property.edt);
            case EPC_EXTENTIONAL_OPERATION_TIMER_TIME_SETTING_VALUE:
                return isValidExtentionalOperationTimerTimeSettingValue(property.edt);
            case EPC_ION_EMISSION_SETTING:
                return isValidIonEmissionSetting(property.edt);
            case EPC_IMPLEMENTED_ION_EMISSION_METHOD:
                return isValidImplementedIonEmissionMethod(property.edt);
            case EPC_OIL_AMOUNT_LEVEL:
                return isValidOilAmountLevel(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends FanHeater {
        ...
        @Override
        protected boolean setTemperatureSettingValue(byte[] edt) {
            return false;
        }

        @Override
        protected byte[] getTemperatureSettingValue() {
            return null;
        }
    }
