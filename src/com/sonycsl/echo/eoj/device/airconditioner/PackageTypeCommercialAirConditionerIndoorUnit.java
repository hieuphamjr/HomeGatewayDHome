...
public abstract class PackageTypeCommercialAirConditionerIndoorUnit extends DeviceObject {
     ...
     * <b>Announcement at status change</b><br>
     */
    protected boolean setRelativeHumiditySettingForDehumidificaTionMode1(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setTemperatureSettingForCoolingMode1(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setTemperatureSettingForHeatingMode1(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setTemperatureSettingForDehumidificaTionMode1(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setVentilationModeSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setCombinedOperationOfIndoorUnitAndTotalHeatExchanger(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setDisablingOfAirConditionerSetting(byte[] edt) {
        return false;
    }
     ...
     * <b>Announcement at status change</b><br>
     */
    protected boolean setFilterCleaningReminderLampSetting(byte[] edt) {
        return false;
    }
     ...
     * <b>Announcement at status change</b><br>
     */
    protected boolean setRelativeHumiditySettingForDehumidificatioNMode2(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setTemperatureSettingForCoolingMode2(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setTemperatureSettingForHeatingMode2(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setTemperatureSettingForDehumidificatioNMode2(byte[] edt) {
        return false;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            ...
            case EPC_TEMPERATURE_SETTING1:
                return setTemperatureSetting1(property.edt);
            case EPC_RELATIVE_HUMIDITY_SETTING_FOR_DEHUMIDIFICA_TION_MODE1:
                return setRelativeHumiditySettingForDehumidificaTionMode1(property.edt);
            case EPC_TEMPERATURE_SETTING_FOR_COOLING_MODE1:
                return setTemperatureSettingForCoolingMode1(property.edt);
            case EPC_TEMPERATURE_SETTING_FOR_HEATING_MODE1:
                return setTemperatureSettingForHeatingMode1(property.edt);
            case EPC_TEMPERATURE_SETTING_FOR_DEHUMIDIFICA_TION_MODE1:
                return setTemperatureSettingForDehumidificaTionMode1(property.edt);
            ...
            case EPC_VENTILATION_MODE_SETTING:
                return setVentilationModeSetting(property.edt);
            case EPC_COMBINED_OPERATION_OF_INDOOR_UNIT_AND_TOTAL_HEAT_EXCHANGER:
                return setCombinedOperationOfIndoorUnitAndTotalHeatExchanger(property.edt);
            ...
            case EPC_DISABLING_OF_AIR_CONDITIONER_SETTING:
                return setDisablingOfAirConditionerSetting(property.edt);
            ...
            case EPC_FILTER_CLEANING_REMINDER_LAMP_SETTING:
                return setFilterCleaningReminderLampSetting(property.edt);
            case EPC_TEMPERATURE_SETTING2:
                return setTemperatureSetting2(property.edt);
            case EPC_RELATIVE_HUMIDITY_SETTING_FOR_DEHUMIDIFICATIO_N_MODE2:
                return setRelativeHumiditySettingForDehumidificatioNMode2(property.edt);
            case EPC_TEMPERATURE_SETTING_FOR_COOLING_MODE2:
                return setTemperatureSettingForCoolingMode2(property.edt);
            case EPC_TEMPERATURE_SETTING_FOR_HEATING_MODE2:
                return setTemperatureSettingForHeatingMode2(property.edt);
            case EPC_TEMPERATURE_SETTING_FOR_DEHUMIDIFICATIO_N_MODE2:
                return setTemperatureSettingForDehumidificatioNMode2(property.edt);
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            ...
            case EPC_TEMPERATURE_SETTING1:
                return isValidTemperatureSetting1(property.edt);
            case EPC_RELATIVE_HUMIDITY_SETTING_FOR_DEHUMIDIFICA_TION_MODE1:
                return isValidRelativeHumiditySettingForDehumidificaTionMode1(property.edt);
            case EPC_TEMPERATURE_SETTING_FOR_COOLING_MODE1:
                return isValidTemperatureSettingForCoolingMode1(property.edt);
            case EPC_TEMPERATURE_SETTING_FOR_HEATING_MODE1:
                return isValidTemperatureSettingForHeatingMode1(property.edt);
            case EPC_TEMPERATURE_SETTING_FOR_DEHUMIDIFICA_TION_MODE1:
                return isValidTemperatureSettingForDehumidificaTionMode1(property.edt);
            case EPC_RATED_POWER_CONSUMPTION_OF_INDOOR_UNIT:
                return isValidRatedPowerConsumptionOfIndoorUnit(property.edt);
            case EPC_MEASURED_ELECTRIC_CURRENT_CONSUMPTION_OF_INDOOR_UNIT:
                return isValidMeasuredElectricCurrentConsumptionOfIndoorUnit(property.edt);
            case EPC_MEASURED_INDOOR_RELATIVE_HUMIDITY1:
                return isValidMeasuredIndoorRelativeHumidity1(property.edt);
            case EPC_MEASURED_INDOOR_TEMPERATURE1:
                return isValidMeasuredIndoorTemperature1(property.edt);
            case EPC_RELATIVE_TEMPERATURE_SETTING:
            ...
            case EPC_THERMOSTAT_STATE:
                return isValidThermostatState(property.edt);
            case EPC_CURRENT_FUNCTION_AUTOMATIC_OPERATION_MODE:
                return isValidCurrentFunctionAutomaticOperationMode(property.edt);
            case EPC_VENTILATION_MODE_SETTING:
                return isValidVentilationModeSetting(property.edt);
            case EPC_COMBINED_OPERATION_OF_INDOOR_UNIT_AND_TOTAL_HEAT_EXCHANGER:
                return isValidCombinedOperationOfIndoorUnitAndTotalHeatExchanger(property.edt);
            case EPC_VENTILATION_AIR_FLOW_RATE_SETTING:
                return isValidVentilationAirFlowRateSetting(property.edt);
            case EPC_DISABLING_OF_AIR_CONDITIONER_SETTING:
                return isValidDisablingOfAirConditionerSetting(property.edt);
            case EPC_THERMOSTAT_SETTING_OVERRIDE_FUNCTION:
                return isValidThermostatSettingOverrideFunction(property.edt);
            case EPC_FILTER_CLEANING_REMINDER_LAMP_SETTING:
                return isValidFilterCleaningReminderLampSetting(property.edt);
            case EPC_MEASURED_POWER_CONSUMPTION_OF_INDOOR_UNIT:
                return isValidMeasuredPowerConsumptionOfIndoorUnit(property.edt);
            case EPC_APERTURE_OF_EXPANSION_VALVE:
                return isValidApertureOfExpansionValve(property.edt);
            case EPC_TEMPERATURE_SETTING2:
                return isValidTemperatureSetting2(property.edt);
            case EPC_RELATIVE_HUMIDITY_SETTING_FOR_DEHUMIDIFICATIO_N_MODE2:
                return isValidRelativeHumiditySettingForDehumidificatioNMode2(property.edt);
            case EPC_TEMPERATURE_SETTING_FOR_COOLING_MODE2:
                return isValidTemperatureSettingForCoolingMode2(property.edt);
            case EPC_TEMPERATURE_SETTING_FOR_HEATING_MODE2:
                return isValidTemperatureSettingForHeatingMode2(property.edt);
            case EPC_TEMPERATURE_SETTING_FOR_DEHUMIDIFICATIO_N_MODE2:
                return isValidTemperatureSettingForDehumidificatioNMode2(property.edt);
            case EPC_MEASURED_INDOOR_RELATIVE_HUMIDITY2:
                return isValidMeasuredIndoorRelativeHumidity2(property.edt);
            case EPC_MEASURED_INDOOR_TEMPERATURE2:
                return isValidMeasuredIndoorTemperature2(property.edt);
            case EPC_ON_TIMER_BASED_RESERVATION_SETTING:
    ...
    public static class Proxy extends PackageTypeCommercialAirConditionerIndoorUnit {
        ...
        @Override
        protected boolean setTemperatureSetting1(byte[] edt) {
            return false;
        }
        ...
        @Override
        protected boolean setTemperatureSetting2(byte[] edt) {
            return false;
        }
