...
public abstract class Humidifier extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected boolean setReservationSetOfOffTimer(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getReservationSetOfOffTimer() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setRelativeTimeValueSetOfOffTimer(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getRelativeTimeValueSetOfOffTimer() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getWaterAmountLevel() {
        return null;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_HUMIDIFYING_SETTING1:
                return setHumidifyingSetting1(property.edt);
            case EPC_HUMIDIFYING_SETTING2:
                return setHumidifyingSetting2(property.edt);
            case EPC_RESERVATION_SET_OF_OFF_TIMER:
                return setReservationSetOfOffTimer(property.edt);
            case EPC_RELATIVE_TIME_VALUE_SET_OF_OFF_TIMER:
                return setRelativeTimeValueSetOfOffTimer(property.edt);
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            case EPC_HUMIDIFYING_SETTING1:
                return getHumidifyingSetting1();
            case EPC_HUMIDIFYING_SETTING2:
                return getHumidifyingSetting2();
            case EPC_MEASURED_VALUE_OF_RELATIVE_HUMIDITY:
                return getMeasuredValueOfRelativeHumidity();
            case EPC_RESERVATION_SET_OF_OFF_TIMER:
                return getReservationSetOfOffTimer();
            case EPC_RELATIVE_TIME_VALUE_SET_OF_OFF_TIMER:
                return getRelativeTimeValueSetOfOffTimer();
            case EPC_ION_EMISSION_SETTING:
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_HUMIDIFYING_SETTING1:
                return isValidHumidifyingSetting1(property.edt);
            case EPC_HUMIDIFYING_SETTING2:
                return isValidHumidifyingSetting2(property.edt);
            case EPC_MEASURED_VALUE_OF_RELATIVE_HUMIDITY:
                return isValidMeasuredValueOfRelativeHumidity(property.edt);
            case EPC_RESERVATION_SET_OF_OFF_TIMER:
                return isValidReservationSetOfOffTimer(property.edt);
            case EPC_RELATIVE_TIME_VALUE_SET_OF_OFF_TIMER:
                return isValidRelativeTimeValueSetOfOffTimer(property.edt);
            case EPC_ION_EMISSION_SETTING:
            ...
            case EPC_WATER_AMOUNT_LEVEL:
                return isValidWaterAmountLevel(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends Humidifier {
        ...
        @Override
        protected boolean setHumidifyingSetting1(byte[] edt) {
            return false;
        }

        @Override
        protected byte[] getHumidifyingSetting1() {
            return null;
        }

        @Override
        protected boolean setHumidifyingSetting2(byte[] edt) {
            return false;
        }

        @Override
        protected byte[] getHumidifyingSetting2() {
            return null;
        }
    }
