...
public abstract class AirCleaner extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected byte[] getFilterChangeNotice() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setOpticalCatalystOperationSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getOpticalCatalystOperationSetting() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getAirPollutionDetectionStatus() {
        return null;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            ...
            case EPC_OPTICAL_CATALYST_OPERATION_SETTING:
                return setOpticalCatalystOperationSetting(property.edt);
            default:
                return false;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_FILTER_CHANGE_NOTICE:
                return isValidFilterChangeNotice(property.edt);
            case EPC_AIR_FLOW_RATE_SETTING:
                return isValidAirFlowRateSetting(property.edt);
            case EPC_SMOKE_CIGARETTE_DETECTION_STATUS:
                return isValidSmokeCigaretteDetectionStatus(property.edt);
            case EPC_OPTICAL_CATALYST_OPERATION_SETTING:
                return isValidOpticalCatalystOperationSetting(property.edt);
            case EPC_AIR_POLLUTION_DETECTION_STATUS:
                return isValidAirPollutionDetectionStatus(property.edt);
            default:
                return false;
        }
    }
