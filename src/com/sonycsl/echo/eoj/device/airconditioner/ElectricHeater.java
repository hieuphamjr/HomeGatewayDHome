...
public abstract class ElectricHeater extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected byte[] getRemotelySetTemperature() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setSetValueOfOffTimerRelativeTime(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getSetValueOfOffTimerRelativeTime() {
        return null;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            ...
            case EPC_TEMPERATURE_SETTING:
                return setTemperatureSetting(property.edt);
            ...
            case EPC_SET_VALUE_OF_OFF_TIMER_RELATIVE_TIME:
                return setSetValueOfOffTimerRelativeTime(property.edt);
            default:
                return false;
        }
    }
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            ...
            case EPC_SET_VALUE_OF_OFF_TIMER_RELATIVE_TIME:
                return getSetValueOfOffTimerRelativeTime();
            default:
                return null;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            ...
            case EPC_TEMPERATURE_SETTING:
                return isValidTemperatureSetting(property.edt);
            case EPC_MEASURED_ROOM_TEMPERATURE:
                return isValidMeasuredRoomTemperature(property.edt);
            case EPC_REMOTELY_SET_TEMPERATURE:
                return isValidRemotelySetTemperature(property.edt);
            case EPC_AIR_FLOW_RATE_SETTING:
            ...
            case EPC_SET_VALUE_OF_OFF_TIMER_RELATIVE_TIME:
                return isValidSetValueOfOffTimerRelativeTime(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends ElectricHeater {
        ...
        @Override
        protected boolean setTemperatureSetting(byte[] edt) {
            return false;
        }

        @Override
        protected byte[] getTemperatureSetting() {
            return null;
        }
    }
