...
public abstract class AirConditionerVentilationFan extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected boolean setSetValueOfRoomRelativeHumidity(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getSetValueOfRoomRelativeHumidity() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setVentilationAutoSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getVentilationAutoSetting() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setSetValueOfVentilationAirFlowRate(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getSetValueOfVentilationAirFlowRate() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setHeatExchangerOperationSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getHeatExchangerOperationSetting() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getMeasuredValueOfCo2Concentration() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getSmokeCigaretteDetectionStatus() {
        return null;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_SET_VALUE_OF_ROOM_RELATIVE_HUMIDITY:
                return setSetValueOfRoomRelativeHumidity(property.edt);
            case EPC_VENTILATION_AUTO_SETTING:
                return setVentilationAutoSetting(property.edt);
            case EPC_SET_VALUE_OF_VENTILATION_AIR_FLOW_RATE:
                return setSetValueOfVentilationAirFlowRate(property.edt);
            case EPC_HEAT_EXCHANGER_OPERATION_SETTING:
                return setHeatExchangerOperationSetting(property.edt);
            default:
                return false;
        }
    }
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            case EPC_SET_VALUE_OF_ROOM_RELATIVE_HUMIDITY:
                return getSetValueOfRoomRelativeHumidity();
            case EPC_VENTILATION_AUTO_SETTING:
                return getVentilationAutoSetting();
            case EPC_MEASURED_VALUE_OF_ROOM_RELATIVE_HUMIDITY:
                return getMeasuredValueOfRoomRelativeHumidity();
            case EPC_SET_VALUE_OF_VENTILATION_AIR_FLOW_RATE:
                return getSetValueOfVentilationAirFlowRate();
            case EPC_HEAT_EXCHANGER_OPERATION_SETTING:
                return getHeatExchangerOperationSetting();
            case EPC_MEASURED_VALUE_OF_CO2_CONCENTRATION:
                return getMeasuredValueOfCo2Concentration();
            case EPC_SMOKE_CIGARETTE_DETECTION_STATUS:
                return getSmokeCigaretteDetectionStatus();
            default:
                return null;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_SET_VALUE_OF_ROOM_RELATIVE_HUMIDITY:
                return isValidSetValueOfRoomRelativeHumidity(property.edt);
            case EPC_VENTILATION_AUTO_SETTING:
                return isValidVentilationAutoSetting(property.edt);
            case EPC_MEASURED_VALUE_OF_ROOM_RELATIVE_HUMIDITY:
                return isValidMeasuredValueOfRoomRelativeHumidity(property.edt);
            case EPC_SET_VALUE_OF_VENTILATION_AIR_FLOW_RATE:
                return isValidSetValueOfVentilationAirFlowRate(property.edt);
            case EPC_HEAT_EXCHANGER_OPERATION_SETTING:
                return isValidHeatExchangerOperationSetting(property.edt);
            case EPC_MEASURED_VALUE_OF_CO2_CONCENTRATION:
                return isValidMeasuredValueOfCo2Concentration(property.edt);
            case EPC_SMOKE_CIGARETTE_DETECTION_STATUS:
                return isValidSmokeCigaretteDetectionStatus(property.edt);
            default:
                return false;
        }
    }
