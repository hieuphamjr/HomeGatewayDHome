...
public abstract class PackageTypeCommercialAirConditionerOutdoorUnit extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected byte[] getRatedPowerConsumptionOfOutdoorUnit() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getMeasuredElectricCurrentConsumptionOfOutdoorUnit() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getMeasuredOutdoorAirTemperature1() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getOperationStatusOfCompressor() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getFanRotationSpeed() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getMeasuredPowerConsumptionOfOutdoorUnit() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getMeasuredOutdoorAirTemperature2() {
        return null;
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            ...
            case EPC_RATED_POWER_CONSUMPTION_OF_OUTDOOR_UNIT:
                return isValidRatedPowerConsumptionOfOutdoorUnit(property.edt);
            case EPC_MEASURED_ELECTRIC_CURRENT_CONSUMPTION_OF_OUTDOOR_UNIT:
                return isValidMeasuredElectricCurrentConsumptionOfOutdoorUnit(property.edt);
            case EPC_MEASURED_OUTDOOR_AIR_TEMPERATURE1:
                return isValidMeasuredOutdoorAirTemperature1(property.edt);
            case EPC_SPECIAL_STATE:
                return isValidSpecialState(property.edt);
            case EPC_OPERATION_STATUS_OF_COMPRESSOR:
                return isValidOperationStatusOfCompressor(property.edt);
            case EPC_OPERATION_MODE_INFORMATION:
                return isValidOperationModeInformation(property.edt);
            case EPC_FAN_ROTATION_SPEED:
                return isValidFanRotationSpeed(property.edt);
            case EPC_MEASURED_POWER_CONSUMPTION_OF_OUTDOOR_UNIT:
                return isValidMeasuredPowerConsumptionOfOutdoorUnit(property.edt);
            case EPC_MEASURED_OUTDOOR_AIR_TEMPERATURE2:
                return isValidMeasuredOutdoorAirTemperature2(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends PackageTypeCommercialAirConditionerOutdoorUnit {
        ...
        @Override
        protected byte[] getOperationModeInformation() {
            return null;
        }
    }
