...
public abstract class Switch extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected boolean setConnectedDevice(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getConnectedDevice() {
        return null;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_CONNECTED_DEVICE:
                return setConnectedDevice(property.edt);
            default:
                return false;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_CONNECTED_DEVICE:
                return isValidConnectedDevice(property.edt);
            default:
                return false;
        }
    }
