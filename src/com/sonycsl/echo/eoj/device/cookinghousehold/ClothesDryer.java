...
public abstract class ClothesDryer extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected boolean setDryingSetting(byte[] edt) {
        return false;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_DRYING_SETTING:
                return setDryingSetting(property.edt);
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            ...
            case EPC_DRYING_SETTING:
                return isValidDryingSetting(property.edt);
            case EPC_DRYING_STATUS:
                return isValidDryingStatus(property.edt);
            case EPC_REMAINING_DRYING_TIME:
