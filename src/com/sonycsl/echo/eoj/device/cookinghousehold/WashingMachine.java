...
public abstract class WashingMachine extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected boolean setWashingMachineSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getWashingMachineSetting() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getCurrentStageOfWashingCycle() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getTimeRemainingToCompleteWashingCycle() {
        return null;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_WASHING_MACHINE_SETTING:
                return setWashingMachineSetting(property.edt);
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            ...
            case EPC_WASHING_MACHINE_SETTING:
                return getWashingMachineSetting();
            case EPC_CURRENT_STAGE_OF_WASHING_CYCLE:
                return getCurrentStageOfWashingCycle();
            case EPC_TIME_REMAINING_TO_COMPLETE_WASHING_CYCLE:
                return getTimeRemainingToCompleteWashingCycle();
            case EPC_ON_TIMER_RESERVATION_SETTING:
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            ...
            case EPC_WASHING_MACHINE_SETTING:
                return isValidWashingMachineSetting(property.edt);
            case EPC_CURRENT_STAGE_OF_WASHING_CYCLE:
                return isValidCurrentStageOfWashingCycle(property.edt);
            case EPC_TIME_REMAINING_TO_COMPLETE_WASHING_CYCLE:
                return isValidTimeRemainingToCompleteWashingCycle(property.edt);
            case EPC_ON_TIMER_RESERVATION_SETTING:
