...
public abstract class RiceCooker extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected byte[] getCoverOpenCloseStatus() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setWarmerSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getWarmerSetting() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getInnerPotRemovalStatus() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getCoverRemovalStatus() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setRiceCookingReservationSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getRiceCookingReservationSetting() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setSetValueOfRiceCookingReservationSettingTime(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getSetValueOfRiceCookingReservationSettingTime() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setSetValueOfRiceCookingReservationSettingRelativeTime(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getSetValueOfRiceCookingReservationSettingRelativeTime() {
        return null;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_RICE_COOKING_CONTROL_SETTING:
                return setRiceCookingControlSetting(property.edt);
            case EPC_WARMER_SETTING:
                return setWarmerSetting(property.edt);
            case EPC_RICE_COOKING_RESERVATION_SETTING:
                return setRiceCookingReservationSetting(property.edt);
            case EPC_SET_VALUE_OF_RICE_COOKING_RESERVATION_SETTING_TIME:
                return setSetValueOfRiceCookingReservationSettingTime(property.edt);
            case EPC_SET_VALUE_OF_RICE_COOKING_RESERVATION_SETTING_RELATIVE_TIME:
                return setSetValueOfRiceCookingReservationSettingRelativeTime(property.edt);
            default:
                return false;
        }
    }
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            case EPC_COVER_OPEN_CLOSE_STATUS:
                return getCoverOpenCloseStatus();
            case EPC_RICE_COOKING_STATUS:
                return getRiceCookingStatus();
            case EPC_RICE_COOKING_CONTROL_SETTING:
                return getRiceCookingControlSetting();
            case EPC_WARMER_SETTING:
                return getWarmerSetting();
            case EPC_INNER_POT_REMOVAL_STATUS:
                return getInnerPotRemovalStatus();
            case EPC_COVER_REMOVAL_STATUS:
                return getCoverRemovalStatus();
            case EPC_RICE_COOKING_RESERVATION_SETTING:
                return getRiceCookingReservationSetting();
            case EPC_SET_VALUE_OF_RICE_COOKING_RESERVATION_SETTING_TIME:
                return getSetValueOfRiceCookingReservationSettingTime();
            case EPC_SET_VALUE_OF_RICE_COOKING_RESERVATION_SETTING_RELATIVE_TIME:
                return getSetValueOfRiceCookingReservationSettingRelativeTime();
            default:
                return null;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_COVER_OPEN_CLOSE_STATUS:
                return isValidCoverOpenCloseStatus(property.edt);
            case EPC_RICE_COOKING_STATUS:
                return isValidRiceCookingStatus(property.edt);
            case EPC_RICE_COOKING_CONTROL_SETTING:
                return isValidRiceCookingControlSetting(property.edt);
            case EPC_WARMER_SETTING:
                return isValidWarmerSetting(property.edt);
            case EPC_INNER_POT_REMOVAL_STATUS:
                return isValidInnerPotRemovalStatus(property.edt);
            case EPC_COVER_REMOVAL_STATUS:
                return isValidCoverRemovalStatus(property.edt);
            case EPC_RICE_COOKING_RESERVATION_SETTING:
                return isValidRiceCookingReservationSetting(property.edt);
            case EPC_SET_VALUE_OF_RICE_COOKING_RESERVATION_SETTING_TIME:
                return isValidSetValueOfRiceCookingReservationSettingTime(property.edt);
            case EPC_SET_VALUE_OF_RICE_COOKING_RESERVATION_SETTING_RELATIVE_TIME:
                return isValidSetValueOfRiceCookingReservationSettingRelativeTime(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends RiceCooker {
        ...
        @Override
        protected byte[] getRiceCookingStatus() {
            return null;
        }

        @Override
        protected boolean setRiceCookingControlSetting(byte[] edt) {
            return false;
        }

        @Override
        protected byte[] getRiceCookingControlSetting() {
            return null;
        }
    }
