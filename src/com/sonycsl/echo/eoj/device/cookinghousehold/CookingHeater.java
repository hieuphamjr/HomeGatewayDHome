...
public abstract class CookingHeater extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected boolean setHeatingPowerSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getHeatingPowerSetting() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setHeatingTemperatureSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getHeatingTemperatureSetting() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setHeatingModesOfStovesSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getHeatingModesOfStovesSetting() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setRelativeTimeSettingsOfOffTimers(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getRelativeTimeSettingsOfOffTimers() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setChildLockSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getChildLockSetting() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setRadiantHeaterLockSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getRadiantHeaterLockSetting() {
        return null;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            ...
            case EPC_ALL_STOP_SETTING:
                return setAllStopSetting(property.edt);
            case EPC_HEATING_POWER_SETTING:
                return setHeatingPowerSetting(property.edt);
            case EPC_HEATING_TEMPERATURE_SETTING:
                return setHeatingTemperatureSetting(property.edt);
            case EPC_HEATING_MODES_OF_STOVES_SETTING:
                return setHeatingModesOfStovesSetting(property.edt);
            case EPC_RELATIVE_TIME_SETTINGS_OF_OFF_TIMERS:
                return setRelativeTimeSettingsOfOffTimers(property.edt);
            case EPC_CHILD_LOCK_SETTING:
                return setChildLockSetting(property.edt);
            case EPC_RADIANT_HEATER_LOCK_SETTING:
                return setRadiantHeaterLockSetting(property.edt);
            default:
                return false;
        }
    }
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            ...
            case EPC_HEATING_POWER_SETTING:
                return getHeatingPowerSetting();
            case EPC_HEATING_TEMPERATURE_SETTING:
                return getHeatingTemperatureSetting();
            case EPC_HEATING_MODES_OF_STOVES_SETTING:
                return getHeatingModesOfStovesSetting();
            case EPC_RELATIVE_TIME_SETTINGS_OF_OFF_TIMERS:
                return getRelativeTimeSettingsOfOffTimers();
            case EPC_CHILD_LOCK_SETTING:
                return getChildLockSetting();
            case EPC_RADIANT_HEATER_LOCK_SETTING:
                return getRadiantHeaterLockSetting();
            default:
                return null;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            ...
            case EPC_ALL_STOP_SETTING:
                return isValidAllStopSetting(property.edt);
            case EPC_HEATING_POWER_SETTING:
                return isValidHeatingPowerSetting(property.edt);
            case EPC_HEATING_TEMPERATURE_SETTING:
                return isValidHeatingTemperatureSetting(property.edt);
            case EPC_HEATING_MODES_OF_STOVES_SETTING:
                return isValidHeatingModesOfStovesSetting(property.edt);
            case EPC_RELATIVE_TIME_SETTINGS_OF_OFF_TIMERS:
                return isValidRelativeTimeSettingsOfOffTimers(property.edt);
            case EPC_CHILD_LOCK_SETTING:
                return isValidChildLockSetting(property.edt);
            case EPC_RADIANT_HEATER_LOCK_SETTING:
                return isValidRadiantHeaterLockSetting(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends CookingHeater {
        ...
        @Override
        protected boolean setAllStopSetting(byte[] edt) {
            return false;
        }
    }
