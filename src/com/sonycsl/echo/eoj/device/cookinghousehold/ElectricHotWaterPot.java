...
public abstract class ElectricHotWaterPot extends DeviceObject {
     ...
     * <b>Announcement at status change</b><br>
     */
    protected byte[] getNoWaterWarning() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setBoilUpSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getBoilUpSetting() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setBoilUpWarmerModeSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getBoilUpWarmerModeSetting() {
        return null;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setSetValueOfWarmerTemperature(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getSetValueOfWarmerTemperature() {
        return null;
    }
     ...
     * <b>Announcement at status change</b><br>
     */
    protected byte[] getHotWaterDischargeStatus() {
        return null;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_BOIL_UP_SETTING:
                return setBoilUpSetting(property.edt);
            case EPC_BOIL_UP_WARMER_MODE_SETTING:
                return setBoilUpWarmerModeSetting(property.edt);
            case EPC_SET_VALUE_OF_WARMER_TEMPERATURE:
                return setSetValueOfWarmerTemperature(property.edt);
            default:
                return false;
        }
    }
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            ...
            case EPC_NO_WATER_WARNING:
                return getNoWaterWarning();
            case EPC_BOIL_UP_SETTING:
                return getBoilUpSetting();
            case EPC_BOIL_UP_WARMER_MODE_SETTING:
                return getBoilUpWarmerModeSetting();
            case EPC_SET_VALUE_OF_WARMER_TEMPERATURE:
                return getSetValueOfWarmerTemperature();
            case EPC_HOT_WATER_DISCHARGE_STATUS:
                return getHotWaterDischargeStatus();
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            ...
            case EPC_NO_WATER_WARNING:
                return isValidNoWaterWarning(property.edt);
            case EPC_BOIL_UP_SETTING:
                return isValidBoilUpSetting(property.edt);
            case EPC_BOIL_UP_WARMER_MODE_SETTING:
                return isValidBoilUpWarmerModeSetting(property.edt);
            case EPC_SET_VALUE_OF_WARMER_TEMPERATURE:
                return isValidSetValueOfWarmerTemperature(property.edt);
            case EPC_HOT_WATER_DISCHARGE_STATUS:
                return isValidHotWaterDischargeStatus(property.edt);
            case EPC_LOCK_STATUS:
                return isValidLockStatus(property.edt);
            default:
                return false;
        }
    }
