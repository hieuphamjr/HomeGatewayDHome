...
public abstract class Refrigerator extends DeviceObject {
     ...
     * Get - optional<br>
     */
    protected boolean setRefrigeratorCompartmentTemperatureSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setFreezerCompartmentTemperatureSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setIceTemperatureSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setVegetableCompartmentTemperatureSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setMultiRefrigeraTingModeCompartmentTemperatureSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setRefrigeratorCompartmentTemperatureLevelSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setFreezerCompartmentTemperatureLevelSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setIceCompartmentTemperatureLevelSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setVegetableCompartmentTemperatureLevelSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setMultiRefrigeraTingModeCompartmentTemperatureLevelSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setQuickFreezeFunctionSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setQuickRefrigerationFunctionSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setIcemakerSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setRefrigeratorCompartmentHumidificationFunctionSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setVegetableCompartmentHumidificationFunctionSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected boolean setDeodorizationFunctionSetting(byte[] edt) {
        return false;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_REFRIGERATOR_COMPARTMENT_TEMPERATURE_SETTING:
                return setRefrigeratorCompartmentTemperatureSetting(property.edt);
            case EPC_FREEZER_COMPARTMENT_TEMPERATURE_SETTING:
                return setFreezerCompartmentTemperatureSetting(property.edt);
            case EPC_ICE_TEMPERATURE_SETTING:
                return setIceTemperatureSetting(property.edt);
            case EPC_VEGETABLE_COMPARTMENT_TEMPERATURE_SETTING:
                return setVegetableCompartmentTemperatureSetting(property.edt);
            case EPC_MULTI_REFRIGERA_TING_MODE_COMPARTMENT_TEMPERATURE_SETTING:
                return setMultiRefrigeraTingModeCompartmentTemperatureSetting(property.edt);
            case EPC_REFRIGERATOR_COMPARTMENT_TEMPERATURE_LEVEL_SETTING:
                return setRefrigeratorCompartmentTemperatureLevelSetting(property.edt);
            case EPC_FREEZER_COMPARTMENT_TEMPERATURE_LEVEL_SETTING:
                return setFreezerCompartmentTemperatureLevelSetting(property.edt);
            case EPC_ICE_COMPARTMENT_TEMPERATURE_LEVEL_SETTING:
                return setIceCompartmentTemperatureLevelSetting(property.edt);
            case EPC_VEGETABLE_COMPARTMENT_TEMPERATURE_LEVEL_SETTING:
                return setVegetableCompartmentTemperatureLevelSetting(property.edt);
            case EPC_MULTI_REFRIGERA_TING_MODE_COMPARTMENT_TEMPERATURE_LEVEL_SETTING:
                return setMultiRefrigeraTingModeCompartmentTemperatureLevelSetting(property.edt);
            case EPC_QUICK_FREEZE_FUNCTION_SETTING:
                return setQuickFreezeFunctionSetting(property.edt);
            case EPC_QUICK_REFRIGERATION_FUNCTION_SETTING:
                return setQuickRefrigerationFunctionSetting(property.edt);
            case EPC_ICEMAKER_SETTING:
                return setIcemakerSetting(property.edt);
            case EPC_REFRIGERATOR_COMPARTMENT_HUMIDIFICATION_FUNCTION_SETTING:
                return setRefrigeratorCompartmentHumidificationFunctionSetting(property.edt);
            case EPC_VEGETABLE_COMPARTMENT_HUMIDIFICATION_FUNCTION_SETTING:
                return setVegetableCompartmentHumidificationFunctionSetting(property.edt);
            case EPC_DEODORIZATION_FUNCTION_SETTING:
                return setDeodorizationFunctionSetting(property.edt);
            default:
                return false;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            ...
            case EPC_DOOR_OPEN_WARNING:
                return isValidDoorOpenWarning(property.edt);
            case EPC_REFRIGERATOR_COMPARTMENT_DOOR_STATUS:
                return isValidRefrigeratorCompartmentDoorStatus(property.edt);
            case EPC_FREEZER_COMPARTMENT_DOOR_STATUS:
                return isValidFreezerCompartmentDoorStatus(property.edt);
            case EPC_ICE_COMPARTMENT_DOOR_STATUS:
                return isValidIceCompartmentDoorStatus(property.edt);
            case EPC_VEGETABLE_COMPARTMENT_DOOR_STATUS:
                return isValidVegetableCompartmentDoorStatus(property.edt);
            case EPC_MULTI_REFRIGERA_TING_MODE_COMPARTMENT_DOOR:
                return isValidMultiRefrigeraTingModeCompartmentDoor(property.edt);
            case EPC_MAXIMUM_ALLOWABLE_TEMPERATURE_SETTING_LEVEL:
                return isValidMaximumAllowableTemperatureSettingLevel(property.edt);
            case EPC_REFRIGERATOR_COMPARTMENT_TEMPERATURE_SETTING:
                return isValidRefrigeratorCompartmentTemperatureSetting(property.edt);
            case EPC_FREEZER_COMPARTMENT_TEMPERATURE_SETTING:
                return isValidFreezerCompartmentTemperatureSetting(property.edt);
            case EPC_ICE_TEMPERATURE_SETTING:
                return isValidIceTemperatureSetting(property.edt);
            case EPC_VEGETABLE_COMPARTMENT_TEMPERATURE_SETTING:
                return isValidVegetableCompartmentTemperatureSetting(property.edt);
            case EPC_MULTI_REFRIGERA_TING_MODE_COMPARTMENT_TEMPERATURE_SETTING:
                return isValidMultiRefrigeraTingModeCompartmentTemperatureSetting(property.edt);
            case EPC_REFRIGERATOR_COMPARTMENT_TEMPERATURE_LEVEL_SETTING:
                return isValidRefrigeratorCompartmentTemperatureLevelSetting(property.edt);
            case EPC_FREEZER_COMPARTMENT_TEMPERATURE_LEVEL_SETTING:
                return isValidFreezerCompartmentTemperatureLevelSetting(property.edt);
            case EPC_ICE_COMPARTMENT_TEMPERATURE_LEVEL_SETTING:
                return isValidIceCompartmentTemperatureLevelSetting(property.edt);
            case EPC_VEGETABLE_COMPARTMENT_TEMPERATURE_LEVEL_SETTING:
                return isValidVegetableCompartmentTemperatureLevelSetting(property.edt);
            case EPC_MULTI_REFRIGERA_TING_MODE_COMPARTMENT_TEMPERATURE_LEVEL_SETTING:
                return isValidMultiRefrigeraTingModeCompartmentTemperatureLevelSetting(property.edt);
            case EPC_MEASURED_REFRIGERATOR_COMPARTMENT_TEMPERATURE:
                return isValidMeasuredRefrigeratorCompartmentTemperature(property.edt);
            case EPC_MEASURED_FREEZER_COMPARTMENT_TEMPERATURE:
                return isValidMeasuredFreezerCompartmentTemperature(property.edt);
            case EPC_MEASURED_SUBZERO_FRESH_COMPARTMENT_TEMPERATURE:
                return isValidMeasuredSubzeroFreshCompartmentTemperature(property.edt);
            case EPC_MEASURED_VEGETABLE_COMPARTMENT_TEMPERATURE:
                return isValidMeasuredVegetableCompartmentTemperature(property.edt);
            case EPC_MEASURED_MULTI_REFRIGERATIN_G_MODE_COMPARTMENT_TEMPERATURE:
                return isValidMeasuredMultiRefrigeratinGModeCompartmentTemperature(property.edt);
            case EPC_COMPRESSOR_ROTATION_SPEED:
                return isValidCompressorRotationSpeed(property.edt);
            case EPC_MEASURED_ELECTRIC_CURRENT_CONSUMPTION:
                return isValidMeasuredElectricCurrentConsumption(property.edt);
            case EPC_RATED_POWER_CONSUMPTION:
                return isValidRatedPowerConsumption(property.edt);
            case EPC_QUICK_FREEZE_FUNCTION_SETTING:
                return isValidQuickFreezeFunctionSetting(property.edt);
            case EPC_QUICK_REFRIGERATION_FUNCTION_SETTING:
                return isValidQuickRefrigerationFunctionSetting(property.edt);
            case EPC_ICEMAKER_SETTING:
                return isValidIcemakerSetting(property.edt);
            case EPC_ICEMAKER_OPERATION_STATUS:
                return isValidIcemakerOperationStatus(property.edt);
            case EPC_ICEMAKER_TANK_STATUS:
                return isValidIcemakerTankStatus(property.edt);
            case EPC_REFRIGERATOR_COMPARTMENT_HUMIDIFICATION_FUNCTION_SETTING:
                return isValidRefrigeratorCompartmentHumidificationFunctionSetting(property.edt);
            case EPC_VEGETABLE_COMPARTMENT_HUMIDIFICATION_FUNCTION_SETTING:
                return isValidVegetableCompartmentHumidificationFunctionSetting(property.edt);
            case EPC_DEODORIZATION_FUNCTION_SETTING:
                return isValidDeodorizationFunctionSetting(property.edt);
            default:
                return false;
        }
    }
