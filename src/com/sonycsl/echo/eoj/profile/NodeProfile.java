...
public abstract class NodeProfile extends ProfileObject {
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_OPERATING_STATUS:
                return setOperatingStatus(property.edt);
            case EPC_UNIQUE_IDENTIFIER_DATA:
                return setUniqueIdentifierData(property.edt);
            default:
                return false;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_OPERATING_STATUS:
                return isValidOperatingStatus(property.edt);
            case EPC_VERSION_INFORMATION:
                return isValidVersionInformation(property.edt);
            case EPC_IDENTIFICATION_NUMBER:
                return isValidIdentificationNumber(property.edt);
            case EPC_FAULT_CONTENT:
                return isValidFaultContent(property.edt);
            case EPC_UNIQUE_IDENTIFIER_DATA:
                return isValidUniqueIdentifierData(property.edt);
            case EPC_NUMBER_OF_SELF_NODE_INSTANCES:
                return isValidNumberOfSelfNodeInstances(property.edt);
            case EPC_NUMBER_OF_SELF_NODE_CLASSES:
                return isValidNumberOfSelfNodeClasses(property.edt);
            case EPC_INSTANCE_LIST_NOTIFICATION:
                return isValidInstanceListNotification(property.edt);
            case EPC_SELF_NODE_INSTANCE_LIST_S:
                return isValidSelfNodeInstanceListS(property.edt);
            case EPC_SELF_NODE_CLASS_LIST:
                return isValidSelfNodeClassList(property.edt);
            default:
                return false;
        }
    }
